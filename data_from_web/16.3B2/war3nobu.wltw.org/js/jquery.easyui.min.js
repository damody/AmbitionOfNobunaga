...
var _54d=_546.width()-_546.find("table").width()-opts.scrollbarSize;
var rate=_54d/_547;
if(!opts.showHeader){
_54c.hide();
}
...
var col=_52a(_544,_549[i]);
if(_54a(col)){
var _54e=col.width*rate;
_54b(col,_54e);
_54d-=_54e;
}
}
_545.leftWidth=_546.width()-_546.find("table").width()-opts.scrollbarSize;
if(_548){
_54b(_548,_545.leftWidth);
}
_513(_544);
...
col.width+=_54f;
col.boxWidth+=_54f;
_546.find("td[field=\""+col.field+"\"] div.datagrid-cell")._outerWidth(col.width);
};
function _54a(col){
...
var opts=$.data(_551,"datagrid").options;
var dc=$.data(_551,"datagrid").dc;
if(_552){
_4e6(_552);
if(opts.fitColumns){
_4ea(_551);
...
var _553=false;
var _554=_529(_551,true).concat(_529(_551,false));
...
if(_553&&opts.fitColumns){
_4ea(_551);
_543(_551);
}
}
function _4e6(_555){
var _556=dc.view.find("div.datagrid-header td[field=\""+_555+"\"] div.datagrid-cell");
_556.css("width","");
var col=$(_551).datagrid("getColumnOption",_555);
col.width=undefined;
col.boxWidth=undefined;
col.auto=true;
$(_551).datagrid("fixColumnSize",_555);
var _557=Math.max(_556._outerWidth(),_558("allbody"),_558("allfooter"));
_556._outerWidth(_557);
col.width=_557;
col.boxWidth=parseInt(_556[0].style.width);
$(_551).datagrid("fixColumnSize",_555);
opts.onResizeColumn.call(_551,_555,col.width);
function _558(type){
var _559=0;
opts.finder.getTr(_551,0,type).find("td[field=\""+_555+"\"] div.datagrid-cell").each(function(){
...
function _513(_55a,_55b){
var _55c=$.data(_55a,"datagrid");
var opts=_55c.options;
var dc=_55c.dc;
var _55d=dc.view.find("table.datagrid-btable,table.datagrid-ftable");
_55d.css("table-layout","fixed");
if(_55b){
fix(_55b);
}else{
var ff=_529(_55a,true).concat(_529(_55a,false));
for(var i=0;i<ff.length;i++){
fix(ff[i]);
}
}
_55d.css("table-layout","auto");
_55e(_55a);
setTimeout(function(){
_4f7(_55a);
_563(_55a);
...
function fix(_55f){
var col=_52a(_55a,_55f);
if(!col.checkbox){
_55c.ss.set("."+col.cellClass,col.boxWidth?col.boxWidth+"px":"auto");
}
};
};
function _55e(_560){
var dc=$.data(_560,"datagrid").dc;
dc.body1.add(dc.body2).find("td.datagrid-td-merged").each(function(){
var td=$(this);
var _561=td.attr("colspan")||1;
var _562=_52a(_560,td.attr("field")).width;
for(var i=1;i<_561;i++){
td=td.next();
_562+=_52a(_560,td.attr("field")).width+1;
}
$(this).children("div.datagrid-cell")._outerWidth(_562);
});
};
function _563(_564){
...
var cell=$(this);
var _565=cell.parent().attr("field");
var col=$(_564).datagrid("getColumnOption",_565);
cell._outerWidth(col.width);
...
function _529(_569,_56a){
var opts=$.data(_569,"datagrid").options;
var _56b=(_56a==true)?(opts.frozenColumns||[[]]):opts.columns;
if(_56b.length==0){
return [];
}
var _56c=[];
...
function _570(_571,data){
var _572=$.data(_571,"datagrid");
var opts=_572.options;
var dc=_572.dc;
data=opts.loadFilter.call(_571,data);
data.total=parseInt(data.total);
_572.data=data;
if(data.footer){
_572.footer=data.footer;
}
if(!opts.remoteSort&&opts.sortName){
var _573=opts.sortName.split(",");
var _574=opts.sortOrder.split(",");
data.rows.sort(function(r1,r2){
var r=0;
for(var i=0;i<_573.length;i++){
var sn=_573[i];
var so=_574[i];
var col=_52a(_571,sn);
var _575=col.sorter||function(a,b){
return a==b?0:(a>b?1:-1);
};
r=_575(r1[sn],r2[sn])*(so=="asc"?1:-1);
if(r!=0){
return r;
}
}
...
opts.view.onBeforeRender.call(opts.view,_571,data.rows);
}
opts.view.render.call(opts.view,_571,dc.body2,false);
opts.view.render.call(opts.view,_571,dc.body1,true);
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,_571,dc.footer2,false);
opts.view.renderFooter.call(opts.view,_571,dc.footer1,true);
}
if(opts.view.onAfterRender){
opts.view.onAfterRender.call(opts.view,_571);
}
_572.ss.clean();
opts.onLoadSuccess.call(_571,data);
var _576=$(_571).datagrid("getPager");
if(_576.length){
var _577=_576.pagination("options");
if(_577.total!=data.total){
_576.pagination("refresh",{total:data.total});
if(opts.pageNumber!=_577.pageNumber){
opts.pageNumber=_577.pageNumber;
_608(_571);
}
}
}
...
dc.body2.triggerHandler("scroll");
_578();
$(_571).datagrid("autoSizeColumn");
function _578(){
if(opts.idField){
for(var i=0;i<data.rows.length;i++){
var row=data.rows[i];
if(_579(_572.selectedRows,row)){
opts.finder.getTr(_571,i).addClass("datagrid-row-selected");
}
if(_579(_572.checkedRows,row)){
opts.finder.getTr(_571,i).find("div.datagrid-cell-check input[type=checkbox]")._propAttr("checked",true);
}
}
}
function _579(a,r){
...
function _57a(_57b,row){
var _57c=$.data(_57b,"datagrid");
...
function _57d(_57e){
var _57f=$.data(_57e,"datagrid");
var opts=_57f.options;
var data=_57f.data;
if(opts.idField){
return _57f.selectedRows;
}else{
var rows=[];
opts.finder.getTr(_57e,"","selected",2).each(function(){
var _580=parseInt($(this).attr("datagrid-row-index"));
rows.push(data.rows[_580]);
});
return rows;
}
};
function _581(_582){
var _583=$.data(_582,"datagrid");
var opts=_583.options;
if(opts.idField){
return _583.checkedRows;
}else{
var rows=[];
opts.finder.getTr(_582,"","checked",2).each(function(){
rows.push(opts.finder.getRow(_582,$(this)));
});
return rows;
}
};
...
var _588=dc.view2.children("div.datagrid-header")._outerHeight();
var _589=dc.body2;
var _58a=_589.outerHeight(true)-_589.outerHeight();
var top=tr.position().top-_588-_58a;
if(top<0){
_589.scrollTop(_589.scrollTop()+top);
}else{
if(top+tr._outerHeight()>_589.height()-18){
_589.scrollTop(_589.scrollTop()+top+tr._outerHeight()-_589.height()+18);
}
}
}
};
...
opts.finder.getTr(_58c,_58e.highlightIndex).removeClass("datagrid-row-over");
opts.finder.getTr(_58c,_58d).addClass("datagrid-row-over");
_58e.highlightIndex=_58d;
};
function _58f(_590,_591,_592){
var _593=$.data(_590,"datagrid");
var dc=_593.dc;
var opts=_593.options;
var _594=_593.selectedRows;
if(opts.singleSelect){
_595(_590);
_594.splice(0,_594.length);
}
...
if(opts.idField){
_4d8(_594,opts.idField,row);
}
opts.finder.getTr(_590,_591).addClass("datagrid-row-selected");
opts.onSelect.call(_590,_591,row);
_584(_590,_591);
};
function _597(_598,_599,_59a){
var _59b=$.data(_598,"datagrid");
var dc=_59b.dc;
var opts=_59b.options;
var _59c=$.data(_598,"datagrid").selectedRows;
if(!_59a&&opts.checkOnSelect){
_59d(_598,_599,true);
}
opts.finder.getTr(_598,_599).removeClass("datagrid-row-selected");
var row=opts.finder.getRow(_598,_599);
if(opts.idField){
_4d6(_59c,opts.idField,row[opts.idField]);
}
opts.onUnselect.call(_598,_599,row);
};
function _59e(_59f,_5a0){
var _5a1=$.data(_59f,"datagrid");
var opts=_5a1.options;
var rows=_5a1.data.rows;
var _5a2=$.data(_59f,"datagrid").selectedRows;
if(!_5a0&&opts.checkOnSelect){
_5a3(_59f,true);
}
opts.finder.getTr(_59f,"","allbody").addClass("datagrid-row-selected");
if(opts.idField){
for(var _5a4=0;_5a4<rows.length;_5a4++){
_4d8(_5a2,opts.idField,rows[_5a4]);
}
}
opts.onSelectAll.call(_59f,rows);
};
function _595(_5a5,_5a6){
var _5a7=$.data(_5a5,"datagrid");
var opts=_5a7.options;
var rows=_5a7.data.rows;
var _5a8=$.data(_5a5,"datagrid").selectedRows;
if(!_5a6&&opts.checkOnSelect){
_5a9(_5a5,true);
}
opts.finder.getTr(_5a5,"","selected").removeClass("datagrid-row-selected");
if(opts.idField){
for(var _5aa=0;_5aa<rows.length;_5aa++){
_4d6(_5a8,opts.idField,rows[_5aa][opts.idField]);
}
}
opts.onUnselectAll.call(_5a5,rows);
};
function _596(_5ab,_5ac,_5ad){
var _5ae=$.data(_5ab,"datagrid");
var opts=_5ae.options;
if(!_5ad&&opts.selectOnCheck){
_58f(_5ab,_5ac,true);
}
var tr=opts.finder.getTr(_5ab,_5ac).addClass("datagrid-row-checked");
var ck=tr.find("div.datagrid-cell-check input[type=checkbox]");
ck._propAttr("checked",true);
tr=opts.finder.getTr(_5ab,"","checked",2);
if(tr.length==_5ae.data.rows.length){
var dc=_5ae.dc;
var _5af=dc.header1.add(dc.header2);
_5af.find("input[type=checkbox]")._propAttr("checked",true);
}
var row=opts.finder.getRow(_5ab,_5ac);
if(opts.idField){
_4d8(_5ae.checkedRows,opts.idField,row);
}
opts.onCheck.call(_5ab,_5ac,row);
};
function _59d(_5b0,_5b1,_5b2){
var _5b3=$.data(_5b0,"datagrid");
var opts=_5b3.options;
if(!_5b2&&opts.selectOnCheck){
_597(_5b0,_5b1,true);
}
var tr=opts.finder.getTr(_5b0,_5b1).removeClass("datagrid-row-checked");
var ck=tr.find("div.datagrid-cell-check input[type=checkbox]");
ck._propAttr("checked",false);
var dc=_5b3.dc;
var _5b4=dc.header1.add(dc.header2);
_5b4.find("input[type=checkbox]")._propAttr("checked",false);
var row=opts.finder.getRow(_5b0,_5b1);
if(opts.idField){
_4d6(_5b3.checkedRows,opts.idField,row[opts.idField]);
}
opts.onUncheck.call(_5b0,_5b1,row);
};
function _5a3(_5b5,_5b6){
var _5b7=$.data(_5b5,"datagrid");
var opts=_5b7.options;
var rows=_5b7.data.rows;
if(!_5b6&&opts.selectOnCheck){
_59e(_5b5,true);
}
var dc=_5b7.dc;
var hck=dc.header1.add(dc.header2).find("input[type=checkbox]");
var bck=opts.finder.getTr(_5b5,"","allbody").addClass("datagrid-row-checked").find("div.datagrid-cell-check input[type=checkbox]");
hck.add(bck)._propAttr("checked",true);
if(opts.idField){
for(var i=0;i<rows.length;i++){
_4d8(_5b7.checkedRows,opts.idField,rows[i]);
}
}
opts.onCheckAll.call(_5b5,rows);
};
function _5a9(_5b8,_5b9){
var _5ba=$.data(_5b8,"datagrid");
var opts=_5ba.options;
var rows=_5ba.data.rows;
if(!_5b9&&opts.selectOnCheck){
_595(_5b8,true);
}
var dc=_5ba.dc;
var hck=dc.header1.add(dc.header2).find("input[type=checkbox]");
var bck=opts.finder.getTr(_5b8,"","checked").removeClass("datagrid-row-checked").find("div.datagrid-cell-check input[type=checkbox]");
hck.add(bck)._propAttr("checked",false);
if(opts.idField){
for(var i=0;i<rows.length;i++){
_4d6(_5ba.checkedRows,opts.idField,rows[i][opts.idField]);
}
}
opts.onUncheckAll.call(_5b8,rows);
};
function _5bb(_5bc,_5bd){
var opts=$.data(_5bc,"datagrid").options;
var tr=opts.finder.getTr(_5bc,_5bd);
var row=opts.finder.getRow(_5bc,_5bd);
if(tr.hasClass("datagrid-row-editing")){
return;
}
if(opts.onBeforeEdit.call(_5bc,_5bd,row)==false){
return;
}
...
var ed=$.data(this,"datagrid.editor");
ed.actions.setValue(ed.target,row[_5bf]);
});
_5c0(_5bc,_5bd);
};
function _5c1(_5c2,_5c3,_5c4){
var opts=$.data(_5c2,"datagrid").options;
var _5c5=$.data(_5c2,"datagrid").updatedRows;
var _5c6=$.data(_5c2,"datagrid").insertedRows;
var tr=opts.finder.getTr(_5c2,_5c3);
var row=opts.finder.getRow(_5c2,_5c3);
if(!tr.hasClass("datagrid-row-editing")){
return;
}
if(!_5c4){
...
var ed=$.data(this,"datagrid.editor");
var _5ca=ed.actions.getValue(ed.target);
if(row[_5c9]!=_5ca){
row[_5c9]=_5ca;
_5c7=true;
_5c8[_5c9]=_5ca;
...
_5cb(_5c2,_5c3);
$(_5c2).datagrid("refreshRow",_5c3);
if(!_5c4){
opts.onAfterEdit.call(_5c2,_5c3,row,_5c8);
}else{
opts.onCancelEdit.call(_5c2,_5c3,row);
}
};
...
var _5d3=_5cc(_5d1,_5d2.index!=undefined?_5d2.index:_5d2.id);
for(var i=0;i<_5d3.length;i++){
if(_5d3[i].field==_5d2.field){
return _5d3[i];
}
}
return null;
};
function _5be(_5d4,_5d5){
var opts=$.data(_5d4,"datagrid").options;
var tr=opts.finder.getTr(_5d4,_5d5);
tr.children("td").each(function(){
var cell=$(this).find("div.datagrid-cell");
var _5d6=$(this).attr("field");
var col=_52a(_5d4,_5d6);
if(col&&col.editor){
var _5d7,_5d8;
if(typeof col.editor=="string"){
_5d7=col.editor;
}else{
_5d7=col.editor.type;
_5d8=col.editor.options;
}
var _5d9=opts.editors[_5d7];
if(_5d9){
var _5da=cell.html();
var _5db=cell._outerWidth();
cell.addClass("datagrid-editable");
cell._outerWidth(_5db);
cell.html("<table border=\"0\" cellspacing=\"0\" cellpadding=\"1\"><tr><td></td></tr></table>");
cell.children("table").bind("click dblclick contextmenu",function(e){
e.stopPropagation();
});
$.data(cell[0],"datagrid.editor",{actions:_5d9,target:_5d9.init(cell.find("td"),_5d8),field:_5d6,type:_5d7,oldHtml:_5da});
}
}
});
_4f7(_5d4,_5d5,true);
};
function _5cb(_5dc,_5dd){
var opts=$.data(_5dc,"datagrid").options;
var tr=opts.finder.getTr(_5dc,_5dd);
tr.children("td").each(function(){
var cell=$(this).find("div.datagrid-editable");
if(cell.length){
var ed=$.data(cell[0],"datagrid.editor");
...
function _5c0(_5de,_5df){
var tr=$.data(_5de,"datagrid").options.finder.getTr(_5de,_5df);
if(!tr.hasClass("datagrid-row-editing")){
return true;
}
...
var _5e0=tr.find(".validatebox-invalid");
return _5e0.length==0;
};
function _5e1(_5e2,_5e3){
var _5e4=$.data(_5e2,"datagrid").insertedRows;
var _5e5=$.data(_5e2,"datagrid").deletedRows;
var _5e6=$.data(_5e2,"datagrid").updatedRows;
if(!_5e3){
var rows=[];
rows=rows.concat(_5e4);
...
var _5ea=$.data(_5e8,"datagrid");
var opts=_5ea.options;
var data=_5ea.data;
var _5eb=_5ea.insertedRows;
var _5ec=_5ea.deletedRows;
$(_5e8).datagrid("cancelEdit",_5e9);
var row=data.rows[_5e9];
if(_4d5(_5eb,row)>=0){
_4d6(_5eb,row);
}else{
_5ec.push(row);
}
_4d6(_5ea.selectedRows,opts.idField,data.rows[_5e9][opts.idField]);
_4d6(_5ea.checkedRows,opts.idField,data.rows[_5e9][opts.idField]);
opts.view.deleteRow.call(opts.view,_5e8,_5e9);
if(opts.height=="auto"){
_4f7(_5e8);
}
$(_5e8).datagrid("getPager").pagination("refresh",{total:data.total});
};
function _5ed(_5ee,_5ef){
var data=$.data(_5ee,"datagrid").data;
var view=$.data(_5ee,"datagrid").options.view;
var _5f0=$.data(_5ee,"datagrid").insertedRows;
view.insertRow.call(view,_5ee,_5ef.index,_5ef.row);
_5f0.push(_5ef.row);
$(_5ee).datagrid("getPager").pagination("refresh",{total:data.total});
};
function _5f1(_5f2,row){
var data=$.data(_5f2,"datagrid").data;
var view=$.data(_5f2,"datagrid").options.view;
var _5f3=$.data(_5f2,"datagrid").insertedRows;
view.insertRow.call(view,_5f2,null,row);
_5f3.push(row);
$(_5f2).datagrid("getPager").pagination("refresh",{total:data.total});
};
function _5f4(_5f5){
var _5f6=$.data(_5f5,"datagrid");
var data=_5f6.data;
var rows=data.rows;
var _5f7=[];
for(var i=0;i<rows.length;i++){
_5f7.push($.extend({},rows[i]));
}
_5f6.originalRows=_5f7;
_5f6.updatedRows=[];
_5f6.insertedRows=[];
_5f6.deletedRows=[];
};
...
var _5fd=_5fc.originalRows;
var _5fe=_5fc.insertedRows;
var _5ff=_5fc.deletedRows;
var _600=_5fc.selectedRows;
var _601=_5fc.checkedRows;
var data=_5fc.data;
function _602(a){
var ids=[];
for(var i=0;i<a.length;i++){
...
function _603(ids,_604){
for(var i=0;i<ids.length;i++){
var _605=_57a(_5fb,ids[i]);
if(_605>=0){
(_604=="s"?_58f:_596)(_5fb,_605,true);
}
}
};
for(var i=0;i<data.rows.length;i++){
...
var _606=_602(_600);
var _607=_602(_601);
_600.splice(0,_600.length);
_601.splice(0,_601.length);
data.total+=_5ff.length-_5fe.length;
data.rows=_5fd;
_570(_5fb,data);
_603(_606,"s");
_603(_607,"c");
...
if(_60a){
opts.queryParams=_60a;
}
var _60b=$.extend({},opts.queryParams);
if(opts.pagination){
$.extend(_60b,{page:opts.pageNumber,rows:opts.pageSize});
}
if(opts.sortName){
$.extend(_60b,{sort:opts.sortName,order:opts.sortOrder});
}
if(opts.onBeforeLoad.call(_609,_60b)==false){
return;
}
$(_609).datagrid("loading");
setTimeout(function(){
_60c();
},0);
function _60c(){
var _60d=opts.loader.call(_609,_60b,function(data){
setTimeout(function(){
$(_609).datagrid("loaded");
},0);
_570(_609,data);
setTimeout(function(){
_5f4(_609);
...
opts.onLoadError.apply(_609,arguments);
});
if(_60d==false){
$(_609).datagrid("loaded");
}
...
var opts=$.data(_60f,"datagrid").options;
_610.rowspan=_610.rowspan||1;
_610.colspan=_610.colspan||1;
if(_610.rowspan==1&&_610.colspan==1){
return;
}
var tr=opts.finder.getTr(_60f,(_610.index!=undefined?_610.index:_610.id));
if(!tr.length){
return;
}
var row=opts.finder.getRow(_60f,tr);
var _611=row[_610.field];
var td=tr.find("td[field=\""+_610.field+"\"]");
td.attr("rowspan",_610.rowspan).attr("colspan",_610.colspan);
td.addClass("datagrid-td-merged");
for(var i=1;i<_610.colspan;i++){
td=td.next();
td.hide();
row[td.attr("field")]=_611;
}
for(var i=1;i<_610.rowspan;i++){
tr=tr.next();
if(!tr.length){
break;
}
var row=opts.finder.getRow(_60f,tr);
var td=tr.find("td[field=\""+_610.field+"\"]").hide();
row[td.attr("field")]=_611;
for(var j=1;j<_610.colspan;j++){
td=td.next();
td.hide();
row[td.attr("field")]=_611;
}
...
$.fn.datagrid=function(_612,_613){
if(typeof _612=="string"){
return $.fn.datagrid.methods[_612](this,_613);
}
_612=_612||{};
return this.each(function(){
var _614=$.data(this,"datagrid");
var opts;
if(_614){
opts=$.extend(_614.options,_612);
_614.options=opts;
}else{
opts=$.extend({},$.extend({},$.fn.datagrid.defaults,{queryParams:{}}),$.fn.datagrid.parseOptions(this),_612);
$(this).css("width","").css("height","");
var _615=_50b(this,opts.rownumbers);
if(!opts.columns){
opts.columns=_615.columns;
}
if(!opts.frozenColumns){
opts.frozenColumns=_615.frozenColumns;
}
opts.columns=$.extend(true,[],opts.columns);
opts.frozenColumns=$.extend(true,[],opts.frozenColumns);
opts.view=$.extend({},opts.view);
$.data(this,"datagrid",{options:opts,panel:_615.panel,dc:_615.dc,ss:_615.ss,selectedRows:[],checkedRows:[],data:{total:0,rows:[]},originalRows:[],updatedRows:[],insertedRows:[],deletedRows:[]});
}
_517(this);
if(opts.data){
_570(this,opts.data);
...
var _616={text:{init:function(_617,_618){
var _619=$("<input type=\"text\" class=\"datagrid-editable-input\">").appendTo(_617);
return _619;
},getValue:function(_61a){
return $(_61a).val();
},setValue:function(_61b,_61c){
$(_61b).val(_61c);
},resize:function(_61d,_61e){
$(_61d)._outerWidth(_61e)._outerHeight(22);
}},textarea:{init:function(_61f,_620){
var _621=$("<textarea class=\"datagrid-editable-input\"></textarea>").appendTo(_61f);
return _621;
...
$(_625)._outerWidth(_626);
}},checkbox:{init:function(_627,_628){
var _629=$("<input type=\"checkbox\">").appendTo(_627);
_629.val(_628.on);
_629.attr("offval",_628.off);
return _629;
},getValue:function(_62a){
if($(_62a).is(":checked")){
return $(_62a).val();
}else{
return $(_62a).attr("offval");
}
...
$(_62b)._propAttr("checked",_62d);
}},numberbox:{init:function(_62e,_62f){
var _630=$("<input type=\"text\" class=\"datagrid-editable-input\">").appendTo(_62e);
_630.numberbox(_62f);
return _630;
},destroy:function(_631){
$(_631).numberbox("destroy");
},getValue:function(_632){
$(_632).blur();
return $(_632).numberbox("getValue");
},setValue:function(_633,_634){
$(_633).numberbox("setValue",_634);
},resize:function(_635,_636){
$(_635)._outerWidth(_636)._outerHeight(22);
}},validatebox:{init:function(_637,_638){
var _639=$("<input type=\"text\" class=\"datagrid-editable-input\">").appendTo(_637);
_639.validatebox(_638);
return _639;
},destroy:function(_63a){
$(_63a).validatebox("destroy");
},getValue:function(_63b){
return $(_63b).val();
},setValue:function(_63c,_63d){
$(_63c).val(_63d);
},resize:function(_63e,_63f){
$(_63e)._outerWidth(_63f)._outerHeight(22);
}},datebox:{init:function(_640,_641){
var _642=$("<input type=\"text\">").appendTo(_640);
_642.datebox(_641);
return _642;
},destroy:function(_643){
$(_643).datebox("destroy");
},getValue:function(_644){
return $(_644).datebox("getValue");
},setValue:function(_645,_646){
$(_645).datebox("setValue",_646);
},resize:function(_647,_648){
$(_647).datebox("resize",_648);
}},combobox:{init:function(_649,_64a){
var _64b=$("<input type=\"text\">").appendTo(_649);
_64b.combobox(_64a||{});
return _64b;
},destroy:function(_64c){
$(_64c).combobox("destroy");
},getValue:function(_64d){
var opts=$(_64d).combobox("options");
if(opts.multiple){
return $(_64d).combobox("getValues").join(opts.separator);
}else{
return $(_64d).combobox("getValue");
}
},setValue:function(_64e,_64f){
var opts=$(_64e).combobox("options");
if(opts.multiple){
if(_64f){
$(_64e).combobox("setValues",_64f.split(opts.separator));
}else{
$(_64e).combobox("clear");
}
}else{
$(_64e).combobox("setValue",_64f);
}
},resize:function(_650,_651){
$(_650).combobox("resize",_651);
}},combotree:{init:function(_652,_653){
var _654=$("<input type=\"text\">").appendTo(_652);
_654.combotree(_653);
return _654;
},destroy:function(_655){
$(_655).combotree("destroy");
},getValue:function(_656){
return $(_656).combotree("getValue");
},setValue:function(_657,_658){
$(_657).combotree("setValue",_658);
},resize:function(_659,_65a){
$(_659).combotree("resize",_65a);
}}};
$.fn.datagrid.methods={options:function(jq){
var _65b=$.data(jq[0],"datagrid").options;
var _65c=$.data(jq[0],"datagrid").panel.panel("options");
var opts=$.extend(_65b,{width:_65c.width,height:_65c.height,closed:_65c.closed,collapsed:_65c.collapsed,minimized:_65c.minimized,maximized:_65c.maximized});
return opts;
},getPanel:function(jq){
return $.data(jq[0],"datagrid").panel;
},getPager:function(jq){
return $.data(jq[0],"datagrid").panel.children("div.datagrid-pager");
},getColumnFields:function(jq,_65d){
return _529(jq[0],_65d);
},getColumnOption:function(jq,_65e){
return _52a(jq[0],_65e);
},resize:function(jq,_65f){
return jq.each(function(){
_4e6(this,_65f);
});
},load:function(jq,_660){
return jq.each(function(){
var opts=$(this).datagrid("options");
opts.pageNumber=1;
var _661=$(this).datagrid("getPager");
_661.pagination("refresh",{pageNumber:1});
_608(this,_660);
});
},reload:function(jq,_662){
return jq.each(function(){
_608(this,_662);
});
},reloadFooter:function(jq,_663){
return jq.each(function(){
var opts=$.data(this,"datagrid").options;
var dc=$.data(this,"datagrid").dc;
if(_663){
$.data(this,"datagrid").footer=_663;
}
if(opts.showFooter){
...
if(opts.loadMsg){
var _664=$(this).datagrid("getPanel");
if(!_664.children("div.datagrid-mask").length){
$("<div class=\"datagrid-mask\" style=\"display:block\"></div>").appendTo(_664);
var msg=$("<div class=\"datagrid-mask-msg\" style=\"display:block;left:50%\"></div>").html(opts.loadMsg).appendTo(_664);
...
_665.children("div.datagrid-mask-msg").remove();
_665.children("div.datagrid-mask").remove();
});
},fitColumns:function(jq){
return jq.each(function(){
_543(this);
});
},fixColumnSize:function(jq,_666){
return jq.each(function(){
_513(this,_666);
});
},fixRowHeight:function(jq,_667){
return jq.each(function(){
_4f7(this,_667);
});
},freezeRow:function(jq,_668){
return jq.each(function(){
_504(this,_668);
});
},autoSizeColumn:function(jq,_669){
return jq.each(function(){
_550(this,_669);
});
},loadData:function(jq,data){
...
return jq.each(function(){
var _66a=$.data(this,"datagrid").selectedRows;
_66a.splice(0,_66a.length);
_595(this);
});
},clearChecked:function(jq){
return jq.each(function(){
var _66b=$.data(this,"datagrid").checkedRows;
_66b.splice(0,_66b.length);
_5a9(this);
});
},scrollTo:function(jq,_66c){
return jq.each(function(){
_584(this,_66c);
});
},highlightRow:function(jq,_66d){
return jq.each(function(){
_58b(this,_66d);
_584(this,_66d);
});
...
var opts=$.data(this,"datagrid").options;
if(opts.idField){
var _66f=_57a(this,id);
if(_66f>=0){
$(this).datagrid("selectRow",_66f);
}
}
});
},unselectRow:function(jq,_670){
return jq.each(function(){
_597(this,_670);
});
},checkRow:function(jq,_671){
return jq.each(function(){
_596(this,_671);
});
},uncheckRow:function(jq,_672){
return jq.each(function(){
_59d(this,_672);
});
...
},beginEdit:function(jq,_673){
return jq.each(function(){
_5bb(this,_673);
});
},endEdit:function(jq,_674){
return jq.each(function(){
_5c1(this,_674,false);
});
},cancelEdit:function(jq,_675){
return jq.each(function(){
_5c1(this,_675,true);
});
},getEditors:function(jq,_676){
return _5cc(jq[0],_676);
},getEditor:function(jq,_677){
return _5d0(jq[0],_677);
},refreshRow:function(jq,_678){
return jq.each(function(){
var opts=$.data(this,"datagrid").options;
opts.view.refreshRow.call(opts.view,this,_678);
});
},validateRow:function(jq,_679){
return _5c0(jq[0],_679);
},updateRow:function(jq,_67a){
return jq.each(function(){
var opts=$.data(this,"datagrid").options;
opts.view.updateRow.call(opts.view,this,_67a.index,_67a.row);
});
},appendRow:function(jq,row){
return jq.each(function(){
_5f1(this,row);
});
},insertRow:function(jq,_67b){
return jq.each(function(){
_5ed(this,_67b);
});
},deleteRow:function(jq,_67c){
return jq.each(function(){
_5e7(this,_67c);
});
},getChanges:function(jq,_67d){
return _5e1(jq[0],_67d);
...
},mergeCells:function(jq,_67e){
return jq.each(function(){
_60e(this,_67e);
});
},showColumn:function(jq,_67f){
return jq.each(function(){
var _680=$(this).datagrid("getPanel");
_680.find("td[field=\""+_67f+"\"]").show();
$(this).datagrid("getColumnOption",_67f).hidden=false;
$(this).datagrid("fitColumns");
});
},hideColumn:function(jq,_681){
return jq.each(function(){
var _682=$(this).datagrid("getPanel");
_682.find("td[field=\""+_681+"\"]").hide();
$(this).datagrid("getColumnOption",_681).hidden=true;
$(this).datagrid("fitColumns");
});
}};
$.fn.datagrid.parseOptions=function(_683){
var t=$(_683);
return $.extend({},$.fn.panel.parseOptions(_683),$.parser.parseOptions(_683,["url","toolbar","idField","sortName","sortOrder","pagePosition","resizeHandle",{fitColumns:"boolean",autoRowHeight:"boolean",striped:"boolean",nowrap:"boolean"},{rownumbers:"boolean",singleSelect:"boolean",checkOnSelect:"boolean",selectOnCheck:"boolean"},{pagination:"boolean",pageSize:"number",pageNumber:"number"},{multiSort:"boolean",remoteSort:"boolean",showHeader:"boolean",showFooter:"boolean"},{scrollbarSize:"number"}]),{pageList:(t.attr("pageList")?eval(t.attr("pageList")):undefined),loadMsg:(t.attr("loadMsg")!=undefined?t.attr("loadMsg"):undefined),rowStyler:(t.attr("rowStyler")?eval(t.attr("rowStyler")):undefined)});
};
$.fn.datagrid.parseData=function(_684){
var t=$(_684);
var data={total:0,rows:[]};
var _685=t.datagrid("getColumnFields",true).concat(t.datagrid("getColumnFields",false));
t.find("tbody tr").each(function(){
data.total++;
var row={};
$.extend(row,$.parser.parseOptions(this,["iconCls","state"]));
for(var i=0;i<_685.length;i++){
row[_685[i]]=$(this).find("td:eq("+i+")").html();
}
data.rows.push(row);
});
return data;
};
var _686={render:function(_687,_688,_689){
var _68a=$.data(_687,"datagrid");
var opts=_68a.options;
var rows=_68a.data.rows;
var _68b=$(_687).datagrid("getColumnFields",_689);
if(_689){
if(!(opts.rownumbers||(opts.frozenColumns&&opts.frozenColumns.length))){
return;
}
}
var _68c=["<table class=\"datagrid-btable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<rows.length;i++){
var css=opts.rowStyler?opts.rowStyler.call(_687,i,rows[i]):"";
var _68d="";
var _68e="";
...
var cls="class=\"datagrid-row "+(i%2&&opts.striped?"datagrid-row-alt ":" ")+_68d+"\"";
var _68f=_68e?"style=\""+_68e+"\"":"";
var _690=_68a.rowIdPrefix+"-"+(_689?1:2)+"-"+i;
_68c.push("<tr id=\""+_690+"\" datagrid-row-index=\""+i+"\" "+cls+" "+_68f+">");
_68c.push(this.renderRow.call(this,_687,_68b,_689,i,rows[i]));
_68c.push("</tr>");
}
_68c.push("</tbody></table>");
$(_688).html(_68c.join(""));
},renderFooter:function(_691,_692,_693){
var opts=$.data(_691,"datagrid").options;
var rows=$.data(_691,"datagrid").footer||[];
var _694=$(_691).datagrid("getColumnFields",_693);
var _695=["<table class=\"datagrid-ftable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<rows.length;i++){
_695.push("<tr class=\"datagrid-row\" datagrid-row-index=\""+i+"\">");
_695.push(this.renderRow.call(this,_691,_694,_693,i,rows[i]));
_695.push("</tr>");
}
_695.push("</tbody></table>");
$(_692).html(_695.join(""));
},renderRow:function(_696,_697,_698,_699,_69a){
var opts=$.data(_696,"datagrid").options;
var cc=[];
if(_698&&opts.rownumbers){
var _69b=_699+1;
if(opts.pagination){
_69b+=(opts.pageNumber-1)*opts.pageSize;
}
cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\">"+_69b+"</div></td>");
}
for(var i=0;i<_697.length;i++){
var _69c=_697[i];
var col=$(_696).datagrid("getColumnOption",_69c);
if(col){
var _69d=_69a[_69c];
var css=col.styler?(col.styler(_69d,_69a,_699)||""):"";
var _69e="";
var _69f="";
if(typeof css=="string"){
_69f=css;
...
var cls=_69e?"class=\""+_69e+"\"":"";
var _6a0=col.hidden?"style=\"display:none;"+_69f+"\"":(_69f?"style=\""+_69f+"\"":"");
cc.push("<td field=\""+_69c+"\" "+cls+" "+_6a0+">");
if(col.checkbox){
var _6a0="";
}else{
var _6a0=_69f;
if(col.align){
_6a0+=";text-align:"+col.align+";";
}
if(!opts.nowrap){
_6a0+=";white-space:normal;height:auto;";
}else{
...
cc.push("<div style=\""+_6a0+"\" ");
cc.push(col.checkbox?"class=\"datagrid-cell-check\"":"class=\"datagrid-cell "+col.cellClass+"\"");
cc.push(">");
if(col.checkbox){
cc.push("<input type=\"checkbox\" name=\""+_69c+"\" value=\""+(_69d!=undefined?_69d:"")+"\">");
}else{
if(col.formatter){
cc.push(col.formatter(_69d,_69a,_699));
}else{
cc.push(_69d);
}
}
...
return cc.join("");
},refreshRow:function(_6a1,_6a2){
this.updateRow.call(this,_6a1,_6a2,{});
},updateRow:function(_6a3,_6a4,row){
var opts=$.data(_6a3,"datagrid").options;
var rows=$(_6a3).datagrid("getRows");
$.extend(rows[_6a4],row);
var css=opts.rowStyler?opts.rowStyler.call(_6a3,_6a4,rows[_6a4]):"";
var _6a5="";
var _6a6="";
if(typeof css=="string"){
_6a6=css;
...
var _6a5="datagrid-row "+(_6a4%2&&opts.striped?"datagrid-row-alt ":" ")+_6a5;
function _6a7(_6a8){
var _6a9=$(_6a3).datagrid("getColumnFields",_6a8);
var tr=opts.finder.getTr(_6a3,_6a4,"body",(_6a8?1:2));
var _6aa=tr.find("div.datagrid-cell-check input[type=checkbox]").is(":checked");
tr.html(this.renderRow.call(this,_6a3,_6a9,_6a8,_6a4,rows[_6a4]));
tr.attr("style",_6a6).attr("class",tr.hasClass("datagrid-row-selected")?_6a5+" datagrid-row-selected":_6a5);
if(_6aa){
tr.find("div.datagrid-cell-check input[type=checkbox]")._propAttr("checked",true);
}
};
_6a7.call(this,true);
_6a7.call(this,false);
$(_6a3).datagrid("fixRowHeight",_6a4);
},insertRow:function(_6ab,_6ac,row){
var _6ad=$.data(_6ab,"datagrid");
var opts=_6ad.options;
var dc=_6ad.dc;
var data=_6ad.data;
if(_6ac==undefined||_6ac==null){
_6ac=data.rows.length;
}
if(_6ac>data.rows.length){
_6ac=data.rows.length;
}
function _6ae(_6af){
var _6b0=_6af?1:2;
for(var i=data.rows.length-1;i>=_6ac;i--){
var tr=opts.finder.getTr(_6ab,i,"body",_6b0);
tr.attr("datagrid-row-index",i+1);
tr.attr("id",_6ad.rowIdPrefix+"-"+_6b0+"-"+(i+1));
if(_6af&&opts.rownumbers){
var _6b1=i+2;
if(opts.pagination){
_6b1+=(opts.pageNumber-1)*opts.pageSize;
}
tr.find("div.datagrid-cell-rownumber").html(_6b1);
}
if(opts.striped){
...
function _6b2(_6b3){
var _6b4=_6b3?1:2;
var _6b5=$(_6ab).datagrid("getColumnFields",_6b3);
var _6b6=_6ad.rowIdPrefix+"-"+_6b4+"-"+_6ac;
var tr="<tr id=\""+_6b6+"\" class=\"datagrid-row\" datagrid-row-index=\""+_6ac+"\"></tr>";
if(_6ac>=data.rows.length){
if(data.rows.length){
opts.finder.getTr(_6ab,"","last",_6b4).after(tr);
}else{
var cc=_6b3?dc.body1:dc.body2;
cc.html("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"+tr+"</tbody></table>");
}
}else{
opts.finder.getTr(_6ab,_6ac+1,"body",_6b4).before(tr);
}
};
_6ae.call(this,true);
_6ae.call(this,false);
_6b2.call(this,true);
_6b2.call(this,false);
data.total+=1;
data.rows.splice(_6ac,0,row);
this.refreshRow.call(this,_6ab,_6ac);
},deleteRow:function(_6b7,_6b8){
var _6b9=$.data(_6b7,"datagrid");
var opts=_6b9.options;
var data=_6b9.data;
function _6ba(_6bb){
var _6bc=_6bb?1:2;
for(var i=_6b8+1;i<data.rows.length;i++){
var tr=opts.finder.getTr(_6b7,i,"body",_6bc);
tr.attr("datagrid-row-index",i-1);
tr.attr("id",_6b9.rowIdPrefix+"-"+_6bc+"-"+(i-1));
if(_6bb&&opts.rownumbers){
var _6bd=i;
if(opts.pagination){
_6bd+=(opts.pageNumber-1)*opts.pageSize;
}
tr.find("div.datagrid-cell-rownumber").html(_6bd);
}
if(opts.striped){
tr.removeClass("datagrid-row-alt").addClass((i-1)%2?"datagrid-row-alt":"");
}
...
opts.finder.getTr(_6b7,_6b8).remove();
_6ba.call(this,true);
_6ba.call(this,false);
data.total-=1;
data.rows.splice(_6b8,1);
},onBeforeRender:function(_6be,rows){
},onAfterRender:function(_6bf){
var opts=$.data(_6bf,"datagrid").options;
if(opts.showFooter){
var _6c0=$(_6bf).datagrid("getPanel").find("div.datagrid-footer");
_6c0.find("div.datagrid-cell-rownumber,div.datagrid-cell-check").css("visibility","hidden");
}
}};
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"Processing, please wait ...",rownumbers:false,singleSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_6c1,_6c2){
},loader:function(_6c3,_6c4,_6c5){
var opts=$(this).datagrid("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:_6c3,dataType:"json",success:function(data){
_6c4(data);
},error:function(){
_6c5.apply(this,arguments);
}});
...
},editors:_616,finder:{getTr:function(_6c6,_6c7,type,_6c8){
type=type||"body";
_6c8=_6c8||0;
var _6c9=$.data(_6c6,"datagrid");
var dc=_6c9.dc;
var opts=_6c9.options;
if(_6c8==0){
var tr1=opts.finder.getTr(_6c6,_6c7,type,1);
var tr2=opts.finder.getTr(_6c6,_6c7,type,2);
return tr1.add(tr2);
}else{
if(type=="body"){
var tr=$("#"+_6c9.rowIdPrefix+"-"+_6c8+"-"+_6c7);
if(!tr.length){
tr=(_6c8==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-index="+_6c7+"]");
}
return tr;
}else{
if(type=="footer"){
return (_6c8==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-index="+_6c7+"]");
}else{
if(type=="selected"){
return (_6c8==1?dc.body1:dc.body2).find(">table>tbody>tr.datagrid-row-selected");
}else{
if(type=="highlight"){
return (_6c8==1?dc.body1:dc.body2).find(">table>tbody>tr.datagrid-row-over");
}else{
if(type=="checked"){
return (_6c8==1?dc.body1:dc.body2).find(">table>tbody>tr.datagrid-row-checked");
}else{
if(type=="last"){
return (_6c8==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-index]:last");
}else{
if(type=="allbody"){
return (_6c8==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-index]");
}else{
if(type=="allfooter"){
return (_6c8==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-index]");
}
}
}
}
...
},getRow:function(_6ca,p){
var _6cb=(typeof p=="object")?p.attr("datagrid-row-index"):p;
return $.data(_6ca,"datagrid").data.rows[parseInt(_6cb)];
}},view:_686,onBeforeLoad:function(_6cc){
},onLoadSuccess:function(){
},onLoadError:function(){
},onClickRow:function(_6cd,_6ce){
},onDblClickRow:function(_6cf,_6d0){
},onClickCell:function(_6d1,_6d2,_6d3){
},onDblClickCell:function(_6d4,_6d5,_6d6){
},onSortColumn:function(sort,_6d7){
},onResizeColumn:function(_6d8,_6d9){
},onSelect:function(_6da,_6db){
},onUnselect:function(_6dc,_6dd){
},onSelectAll:function(rows){
},onUnselectAll:function(rows){
},onCheck:function(_6de,_6df){
},onUncheck:function(_6e0,_6e1){
},onCheckAll:function(rows){
},onUncheckAll:function(rows){
},onBeforeEdit:function(_6e2,_6e3){
},onAfterEdit:function(_6e4,_6e5,_6e6){
},onCancelEdit:function(_6e7,_6e8){
},onHeaderContextMenu:function(e,_6e9){
},onRowContextMenu:function(e,_6ea,_6eb){
}});
})(jQuery);
(function($){
var _6ec;
function _6ed(_6ee){
var _6ef=$.data(_6ee,"propertygrid");
var opts=$.data(_6ee,"propertygrid").options;
$(_6ee).datagrid($.extend({},opts,{cls:"propertygrid",view:(opts.showGroup?opts.groupView:opts.view),onClickRow:function(_6f0,row){
if(_6ec!=this){
_6f1(_6ec);
_6ec=this;
}
if(opts.editIndex!=_6f0&&row.editor){
var col=$(this).datagrid("getColumnOption","value");
col.editor=row.editor;
_6f1(_6ec);
$(this).datagrid("beginEdit",_6f0);
$(this).datagrid("getEditors",_6f0)[0].target.focus();
opts.editIndex=_6f0;
}
opts.onClickRow.call(_6ee,_6f0,row);
},loadFilter:function(data){
_6f1(this);
...
var opts=$.data(_6f2,"propertygrid").options;
var _6f3=opts.editIndex;
if(_6f3==undefined){
return;
}
var ed=t.datagrid("getEditors",_6f3)[0];
if(ed){
ed.target.blur();
if(t.datagrid("validateRow",_6f3)){
t.datagrid("endEdit",_6f3);
}else{
t.datagrid("cancelEdit",_6f3);
}
}
opts.editIndex=undefined;
};
$.fn.propertygrid=function(_6f4,_6f5){
if(typeof _6f4=="string"){
var _6f6=$.fn.propertygrid.methods[_6f4];
if(_6f6){
return _6f6(this,_6f5);
}else{
return this.datagrid(_6f4,_6f5);
}
}
_6f4=_6f4||{};
return this.each(function(){
var _6f7=$.data(this,"propertygrid");
if(_6f7){
$.extend(_6f7.options,_6f4);
}else{
var opts=$.extend({},$.fn.propertygrid.defaults,$.fn.propertygrid.parseOptions(this),_6f4);
opts.frozenColumns=$.extend(true,[],opts.frozenColumns);
opts.columns=$.extend(true,[],opts.columns);
...
$.fn.propertygrid.parseOptions=function(_6f8){
return $.extend({},$.fn.datagrid.parseOptions(_6f8),$.parser.parseOptions(_6f8,[{showGroup:"boolean"}]));
};
var _6f9=$.extend({},$.fn.datagrid.defaults.view,{render:function(_6fa,_6fb,_6fc){
var _6fd=[];
var _6fe=this.groups;
for(var i=0;i<_6fe.length;i++){
_6fd.push(this.renderGroup.call(this,_6fa,i,_6fe[i],_6fc));
}
$(_6fb).html(_6fd.join(""));
},renderGroup:function(_6ff,_700,_701,_702){
var _703=$.data(_6ff,"datagrid");
var opts=_703.options;
var _704=$(_6ff).datagrid("getColumnFields",_702);
var _705=[];
_705.push("<div class=\"datagrid-group\" group-index="+_700+">");
_705.push("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\" style=\"height:100%\"><tbody>");
_705.push("<tr>");
if((_702&&(opts.rownumbers||opts.frozenColumns.length))||(!_702&&!(opts.rownumbers||opts.frozenColumns.length))){
_705.push("<td style=\"border:0;text-align:center;width:25px\"><span class=\"datagrid-row-expander datagrid-row-collapse\" style=\"display:inline-block;width:16px;height:16px;cursor:pointer\">&nbsp;</span></td>");
}
_705.push("<td style=\"border:0;\">");
if(!_702){
_705.push("<span class=\"datagrid-group-title\">");
_705.push(opts.groupFormatter.call(_6ff,_701.value,_701.rows));
_705.push("</span>");
}
_705.push("</td>");
_705.push("</tr>");
...
_705.push("</div>");
_705.push("<table class=\"datagrid-btable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>");
var _706=_701.startIndex;
for(var j=0;j<_701.rows.length;j++){
var css=opts.rowStyler?opts.rowStyler.call(_6ff,_706,_701.rows[j]):"";
var _707="";
var _708="";
if(typeof css=="string"){
_708=css;
...
var cls="class=\"datagrid-row "+(_706%2&&opts.striped?"datagrid-row-alt ":" ")+_707+"\"";
var _709=_708?"style=\""+_708+"\"":"";
var _70a=_703.rowIdPrefix+"-"+(_702?1:2)+"-"+_706;
_705.push("<tr id=\""+_70a+"\" datagrid-row-index=\""+_706+"\" "+cls+" "+_709+">");
_705.push(this.renderRow.call(this,_6ff,_704,_702,_706,_701.rows[j]));
_705.push("</tr>");
_706++;
}
_705.push("</tbody></table>");
return _705.join("");
},bindEvents:function(_70b){
var _70c=$.data(_70b,"datagrid");
var dc=_70c.dc;
var body=dc.body1.add(dc.body2);
var _70d=($.data(body[0],"events")||$._data(body[0],"events")).click[0].handler;
body.unbind("click").bind("click",function(e){
var tt=$(e.target);
var _70e=tt.closest("span.datagrid-row-expander");
if(_70e.length){
var _70f=_70e.closest("div.datagrid-group").attr("group-index");
if(_70e.hasClass("datagrid-row-collapse")){
$(_70b).datagrid("collapseGroup",_70f);
}else{
$(_70b).datagrid("expandGroup",_70f);
}
}else{
_70d(e);
}
...
},onBeforeRender:function(_710,rows){
...
for(var i=0;i<rows.length;i++){
var row=rows[i];
var _714=_715(row[opts.groupField]);
if(!_714){
_714={value:row[opts.groupField],rows:[row]};
_713.push(_714);
}else{
_714.rows.push(row);
}
...
var _714=_713[i];
_714.startIndex=_716;
_716+=_714.rows.length;
_717=_717.concat(_714.rows);
}
_711.data.rows=_717;
this.groups=_713;
var that=this;
setTimeout(function(){
that.bindEvents(_710);
},0);
function _715(_718){
for(var i=0;i<_713.length;i++){
var _719=_713[i];
...
$.extend($.fn.datagrid.methods,{expandGroup:function(jq,_71a){
return jq.each(function(){
var view=$.data(this,"datagrid").dc.view;
var _71b=view.find(_71a!=undefined?"div.datagrid-group[group-index=\""+_71a+"\"]":"div.datagrid-group");
var _71c=_71b.find("span.datagrid-row-expander");
if(_71c.hasClass("datagrid-row-expand")){
_71c.removeClass("datagrid-row-expand").addClass("datagrid-row-collapse");
_71b.next("table").show();
}
$(this).datagrid("fixRowHeight");
});
},collapseGroup:function(jq,_71d){
return jq.each(function(){
var view=$.data(this,"datagrid").dc.view;
var _71e=view.find(_71d!=undefined?"div.datagrid-group[group-index=\""+_71d+"\"]":"div.datagrid-group");
var _71f=_71e.find("span.datagrid-row-expander");
if(_71f.hasClass("datagrid-row-collapse")){
_71f.removeClass("datagrid-row-collapse").addClass("datagrid-row-expand");
_71e.next("table").hide();
}
$(this).datagrid("fixRowHeight");
});
}});
$.fn.propertygrid.defaults=$.extend({},$.fn.datagrid.defaults,{singleSelect:true,remoteSort:false,fitColumns:true,loadMsg:"",frozenColumns:[[{field:"f",width:16,resizable:false}]],columns:[[{field:"name",title:"Name",width:100,sortable:true},{field:"value",title:"Value",width:100,resizable:false}]],showGroup:false,groupView:_6f9,groupField:"group",groupFormatter:function(_720,rows){
return _720;
}});
})(jQuery);
(function($){
function _721(_722){
var _723=$.data(_722,"treegrid");
var opts=_723.options;
$(_722).datagrid($.extend({},opts,{url:null,data:null,loader:function(){
return false;
},onBeforeLoad:function(){
return false;
},onLoadSuccess:function(){
},onResizeColumn:function(_724,_725){
_73b(_722);
opts.onResizeColumn.call(_722,_724,_725);
},onSortColumn:function(sort,_726){
opts.sortName=sort;
opts.sortOrder=_726;
if(opts.remoteSort){
_73a(_722);
}else{
var data=$(_722).treegrid("getData");
_750(_722,0,data);
}
opts.onSortColumn.call(_722,sort,_726);
},onBeforeEdit:function(_727,row){
if(opts.onBeforeEdit.call(_722,row)==false){
return false;
}
},onAfterEdit:function(_728,row,_729){
opts.onAfterEdit.call(_722,row,_729);
},onCancelEdit:function(_72a,row){
opts.onCancelEdit.call(_722,row);
},onSelect:function(_72b){
opts.onSelect.call(_722,find(_722,_72b));
},onUnselect:function(_72c){
opts.onUnselect.call(_722,find(_722,_72c));
},onSelectAll:function(){
opts.onSelectAll.call(_722,$.data(_722,"treegrid").data);
},onUnselectAll:function(){
opts.onUnselectAll.call(_722,$.data(_722,"treegrid").data);
},onCheck:function(_72d){
opts.onCheck.call(_722,find(_722,_72d));
},onUncheck:function(_72e){
opts.onUncheck.call(_722,find(_722,_72e));
},onCheckAll:function(){
opts.onCheckAll.call(_722,$.data(_722,"treegrid").data);
},onUncheckAll:function(){
opts.onUncheckAll.call(_722,$.data(_722,"treegrid").data);
},onClickRow:function(_72f){
opts.onClickRow.call(_722,find(_722,_72f));
},onDblClickRow:function(_730){
opts.onDblClickRow.call(_722,find(_722,_730));
},onClickCell:function(_731,_732){
opts.onClickCell.call(_722,_732,find(_722,_731));
},onDblClickCell:function(_733,_734){
opts.onDblClickCell.call(_722,_734,find(_722,_733));
},onRowContextMenu:function(e,_735){
opts.onContextMenu.call(_722,e,find(_722,_735));
}}));
if(!opts.columns){
var _736=$.data(_722,"datagrid").options;
opts.columns=_736.columns;
opts.frozenColumns=_736.frozenColumns;
}
_723.dc=$.data(_722,"datagrid").dc;
if(opts.pagination){
var _737=$(_722).datagrid("getPager");
_737.pagination({pageNumber:opts.pageNumber,pageSize:opts.pageSize,pageList:opts.pageList,onSelectPage:function(_738,_739){
opts.pageNumber=_738;
opts.pageSize=_739;
_73a(_722);
}});
...
var opts=$.data(_73c,"datagrid").options;
var dc=$.data(_73c,"datagrid").dc;
if(!dc.body1.is(":empty")&&(!opts.nowrap||opts.autoRowHeight)){
if(_73d!=undefined){
var _73e=_73f(_73c,_73d);
for(var i=0;i<_73e.length;i++){
_740(_73e[i][opts.idField]);
}
}
}
$(_73c).datagrid("fixRowHeight",_73d);
function _740(_741){
var tr1=opts.finder.getTr(_73c,_741,"body",1);
var tr2=opts.finder.getTr(_73c,_741,"body",2);
tr1.css("height","");
tr2.css("height","");
var _742=Math.max(tr1.height(),tr2.height());
tr1.css("height",_742);
tr2.css("height",_742);
};
};
...
var body=dc.body1.add(dc.body2);
var _747=($.data(body[0],"events")||$._data(body[0],"events")).click[0].handler;
...
var tr1=opts.finder.getTr(_74a,_74b,"body",1);
var tr2=opts.finder.getTr(_74a,_74b,"body",2);
var _74c=$(_74a).datagrid("getColumnFields",true).length+(opts.rownumbers?1:0);
var _74d=$(_74a).datagrid("getColumnFields",false).length;
_74e(tr1,_74c);
_74e(tr2,_74d);
function _74e(tr,_74f){
$("<tr class=\"treegrid-tr-tree\">"+"<td style=\"border:0px\" colspan=\""+_74f+"\">"+"<div></div>"+"</td>"+"</tr>").insertAfter(tr);
};
};
function _750(_751,_752,data,_753){
var _754=$.data(_751,"treegrid");
var opts=_754.options;
var dc=_754.dc;
data=opts.loadFilter.call(_751,data,_752);
var node=find(_751,_752);
if(node){
var _755=opts.finder.getTr(_751,_752,"body",1);
var _756=opts.finder.getTr(_751,_752,"body",2);
var cc1=_755.next("tr.treegrid-tr-tree").children("td").children("div");
var cc2=_756.next("tr.treegrid-tr-tree").children("td").children("div");
if(!_753){
node.children=[];
}
}else{
...
if(opts.view.onBeforeRender){
opts.view.onBeforeRender.call(opts.view,_751,_752,data);
}
opts.view.render.call(opts.view,_751,cc1,true);
opts.view.render.call(opts.view,_751,cc2,false);
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,_751,dc.footer1,true);
opts.view.renderFooter.call(opts.view,_751,dc.footer2,false);
}
if(opts.view.onAfterRender){
opts.view.onAfterRender.call(opts.view,_751);
}
opts.onLoadSuccess.call(_751,node,data);
if(!_752&&opts.pagination){
var _757=$.data(_751,"treegrid").total;
var _758=$(_751).datagrid("getPager");
if(_758.pagination("options").total!=_757){
_758.pagination({total:_757});
}
}
_73b(_751);
_743(_751);
$(_751).treegrid("autoSizeColumn");
};
function _73a(_759,_75a,_75b,_75c,_75d){
var opts=$.data(_759,"treegrid").options;
var body=$(_759).datagrid("getPanel").find("div.datagrid-body");
if(_75b){
opts.queryParams=_75b;
}
var _75e=$.extend({},opts.queryParams);
if(opts.pagination){
$.extend(_75e,{page:opts.pageNumber,rows:opts.pageSize});
}
if(opts.sortName){
$.extend(_75e,{sort:opts.sortName,order:opts.sortOrder});
}
var row=find(_759,_75a);
if(opts.onBeforeLoad.call(_759,row,_75e)==false){
return;
}
var _75f=body.find("tr[node-id=\""+_75a+"\"] span.tree-folder");
_75f.addClass("tree-loading");
$(_759).treegrid("loading");
var _760=opts.loader.call(_759,_75e,function(data){
_75f.removeClass("tree-loading");
$(_759).treegrid("loaded");
_750(_759,_75a,data,_75c);
if(_75d){
_75d();
}
},function(){
_75f.removeClass("tree-loading");
$(_759).treegrid("loaded");
opts.onLoadError.apply(_759,arguments);
if(_75d){
_75d();
}
});
...
function _763(_764){
return $.data(_764,"treegrid").data;
};
function _765(_766,_767){
var row=find(_766,_767);
if(row._parentId){
return find(_766,row._parentId);
}else{
return null;
}
};
function _73f(_768,_769){
var opts=$.data(_768,"treegrid").options;
var body=$(_768).datagrid("getPanel").find("div.datagrid-view2 div.datagrid-body");
var _76a=[];
if(_769){
_76b(_769);
}else{
...
_76a.push(_76c[i]);
_76b(_76c[i][opts.idField]);
}
}
function _76b(_76d){
var _76e=find(_768,_76d);
if(_76e&&_76e.children){
for(var i=0,len=_76e.children.length;i<len;i++){
var _76f=_76e.children[i];
_76a.push(_76f);
_76b(_76f[opts.idField]);
}
}
};
return _76a;
...
function _772(_773){
var rows=[];
var _774=$(_773).datagrid("getPanel");
_774.find("div.datagrid-view2 div.datagrid-body tr.datagrid-row-selected").each(function(){
var id=$(this).attr("node-id");
rows.push(find(_773,id));
});
return rows;
};
...
var opts=$.data(_776,"treegrid").options;
var view=$(_776).datagrid("getPanel").children("div.datagrid-view");
var node=view.find("div.datagrid-body tr[node-id=\""+_777+"\"]").children("td[field=\""+opts.treeField+"\"]");
return node.find("span.tree-indent,span.tree-hit").length;
};
function find(_778,_779){
var opts=$.data(_778,"treegrid").options;
var data=$.data(_778,"treegrid").data;
var cc=[data];
while(cc.length){
var c=cc.shift();
for(var i=0;i<c.length;i++){
var node=c[i];
if(node[opts.idField]==_779){
return node;
}else{
if(node["children"]){
...
if(opts.onBeforeCollapse.call(_77b,row)==false){
return;
}
hit.removeClass("tree-expanded tree-expanded-hover").addClass("tree-collapsed");
hit.next().removeClass("tree-folder-open");
...
if(opts.onBeforeExpand.call(_77e,row)==false){
return;
}
hit.removeClass("tree-collapsed tree-collapsed-hover").addClass("tree-expanded");
hit.next().addClass("tree-folder-open");
var _780=tr.next("tr.treegrid-tr-tree");
if(_780.length){
var cc=_780.children("td").children("div");
_781(cc);
}else{
_749(_77e,row[opts.idField]);
var _780=tr.next("tr.treegrid-tr-tree");
var cc=_780.children("td").children("div");
cc.hide();
var _782=$.extend({},opts.queryParams||{});
_782.id=row[opts.idField];
_73a(_77e,row[opts.idField],_782,true,function(){
if(cc.is(":empty")){
_780.remove();
}else{
_781(cc);
...
$(_77e).treegrid("autoSizeColumn");
_73b(_77e,_77f);
opts.onExpand.call(_77e,row);
});
}else{
cc.show();
$(_77e).treegrid("autoSizeColumn");
...
function _748(_783,_784){
var opts=$.data(_783,"treegrid").options;
var tr=opts.finder.getTr(_783,_784);
var hit=tr.find("span.tree-hit");
if(hit.hasClass("tree-expanded")){
_77a(_783,_784);
}else{
...
var opts=$.data(_786,"treegrid").options;
var _788=_73f(_786,_787);
if(_787){
_788.unshift(find(_786,_787));
}
for(var i=0;i<_788.length;i++){
_77a(_786,_788[i][opts.idField]);
}
};
function _789(_78a,_78b){
var opts=$.data(_78a,"treegrid").options;
var _78c=_73f(_78a,_78b);
if(_78b){
_78c.unshift(find(_78a,_78b));
}
for(var i=0;i<_78c.length;i++){
_77d(_78a,_78c[i][opts.idField]);
}
};
function _78d(_78e,_78f){
var opts=$.data(_78e,"treegrid").options;
var ids=[];
var p=_765(_78e,_78f);
while(p){
...
if(_792.parent){
var tr=opts.finder.getTr(_791,_792.parent);
if(tr.next("tr.treegrid-tr-tree").length==0){
_749(_791,_792.parent);
}
var cell=tr.children("td[field=\""+opts.treeField+"\"]").children("div.datagrid-cell");
var _793=cell.children("span.tree-icon");
if(_793.hasClass("tree-file")){
_793.removeClass("tree-file").addClass("tree-folder tree-folder-open");
var hit=$("<span class=\"tree-hit tree-expanded\"></span>").insertBefore(_793);
if(hit.prev().length){
hit.prev().remove();
}
}
}
_750(_791,_792.parent,_792.data,true);
};
function _794(_795,_796){
var ref=_796.before||_796.after;
var opts=$.data(_795,"treegrid").options;
var _797=_765(_795,ref);
_790(_795,{parent:(_797?_797[opts.idField]:null),data:[_796.data]});
_798(true);
_798(false);
_743(_795);
function _798(_799){
var _79a=_799?1:2;
var tr=opts.finder.getTr(_795,_796.data[opts.idField],"body",_79a);
var _79b=tr.closest("table.datagrid-btable");
tr=tr.parent().children();
var dest=opts.finder.getTr(_795,ref,"body",_79a);
if(_796.before){
...
var opts=$.data(_79d,"treegrid").options;
var tr=opts.finder.getTr(_79d,_79e);
tr.next("tr.treegrid-tr-tree").remove();
tr.remove();
var _79f=del(_79e);
if(_79f){
if(_79f.children.length==0){
tr=opts.finder.getTr(_79d,_79f[opts.idField]);
tr.next("tr.treegrid-tr-tree").remove();
var cell=tr.children("td[field=\""+opts.treeField+"\"]").children("div.datagrid-cell");
...
function del(id){
var cc;
var _7a0=_765(_79d,_79e);
if(_7a0){
cc=_7a0.children;
}else{
cc=$(_79d).treegrid("getData");
}
for(var i=0;i<cc.length;i++){
...
$.fn.treegrid=function(_7a1,_7a2){
if(typeof _7a1=="string"){
var _7a3=$.fn.treegrid.methods[_7a1];
if(_7a3){
return _7a3(this,_7a2);
}else{
return this.datagrid(_7a1,_7a2);
}
}
_7a1=_7a1||{};
return this.each(function(){
var _7a4=$.data(this,"treegrid");
if(_7a4){
$.extend(_7a4.options,_7a1);
}else{
_7a4=$.data(this,"treegrid",{options:$.extend({},$.fn.treegrid.defaults,$.fn.treegrid.parseOptions(this),_7a1),data:[]});
}
_721(this);
if(_7a4.options.data){
$(this).treegrid("loadData",_7a4.options.data);
}
_73a(this);
_745(this);
});
...
},resize:function(jq,_7a5){
return jq.each(function(){
$(this).datagrid("resize",_7a5);
});
},fixRowHeight:function(jq,_7a6){
return jq.each(function(){
_73b(this,_7a6);
});
},loadData:function(jq,data){
return jq.each(function(){
_750(this,data.parent,data);
});
},load:function(jq,_7a7){
return jq.each(function(){
$(this).treegrid("options").pageNumber=1;
$(this).treegrid("getPager").pagination({pageNumber:1});
$(this).treegrid("reload",_7a7);
});
...
_7a8=$.extend({},opts.queryParams);
_7a8.id=id;
}
if(_7a8.id){
var node=$(this).treegrid("find",_7a8.id);
if(node.children){
node.children.splice(0,node.children.length);
}
opts.queryParams=_7a8;
var tr=opts.finder.getTr(this,_7a8.id);
tr.next("tr.treegrid-tr-tree").remove();
...
},reloadFooter:function(jq,_7a9){
return jq.each(function(){
var opts=$.data(this,"treegrid").options;
var dc=$.data(this,"datagrid").dc;
if(_7a9){
$.data(this,"treegrid").footer=_7a9;
}
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,this,dc.footer1,true);
opts.view.renderFooter.call(opts.view,this,dc.footer2,false);
...
},append:function(jq,_7aa){
return jq.each(function(){
_790(this,_7aa);
});
},insert:function(jq,_7ab){
return jq.each(function(){
_794(this,_7ab);
});
...
},update:function(jq,_7ac){
return jq.each(function(){
var opts=$.data(this,"treegrid").options;
opts.view.updateRow.call(opts.view,this,_7ac.id,_7ac.row);
});
...
$.fn.treegrid.parseOptions=function(_7ad){
return $.extend({},$.fn.datagrid.parseOptions(_7ad),$.parser.parseOptions(_7ad,["treeField",{animate:"boolean"}]));
};
var _7ae=$.extend({},$.fn.datagrid.defaults.view,{render:function(_7af,_7b0,_7b1){
var opts=$.data(_7af,"treegrid").options;
var _7b2=$(_7af).datagrid("getColumnFields",_7b1);
var _7b3=$.data(_7af,"datagrid").rowIdPrefix;
if(_7b1){
if(!(opts.rownumbers||(opts.frozenColumns&&opts.frozenColumns.length))){
return;
}
...
var _7b4=0;
var view=this;
var _7b5=_7b6(_7b1,this.treeLevel,this.treeNodes);
$(_7b0).append(_7b5.join(""));
function _7b6(_7b7,_7b8,_7b9){
var _7ba=["<table class=\"datagrid-btable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<_7b9.length;i++){
var row=_7b9[i];
if(row.state!="open"&&row.state!="closed"){
row.state="open";
}
var css=opts.rowStyler?opts.rowStyler.call(_7af,row):"";
var _7bb="";
var _7bc="";
if(typeof css=="string"){
_7bc=css;
...
var cls="class=\"datagrid-row "+(_7b4++%2&&opts.striped?"datagrid-row-alt ":" ")+_7bb+"\"";
var _7bd=_7bc?"style=\""+_7bc+"\"":"";
var _7be=_7b3+"-"+(_7b7?1:2)+"-"+row[opts.idField];
_7ba.push("<tr id=\""+_7be+"\" node-id=\""+row[opts.idField]+"\" "+cls+" "+_7bd+">");
_7ba=_7ba.concat(view.renderRow.call(view,_7af,_7b2,_7b7,_7b8,row));
_7ba.push("</tr>");
if(row.children&&row.children.length){
var tt=_7b6(_7b7,_7b8+1,row.children);
var v=row.state=="closed"?"none":"block";
_7ba.push("<tr class=\"treegrid-tr-tree\"><td style=\"border:0px\" colspan="+(_7b2.length+(opts.rownumbers?1:0))+"><div style=\"display:"+v+"\">");
_7ba=_7ba.concat(tt);
_7ba.push("</div></td></tr>");
}
}
_7ba.push("</tbody></table>");
return _7ba;
};
},renderFooter:function(_7bf,_7c0,_7c1){
var opts=$.data(_7bf,"treegrid").options;
var rows=$.data(_7bf,"treegrid").footer||[];
var _7c2=$(_7bf).datagrid("getColumnFields",_7c1);
var _7c3=["<table class=\"datagrid-ftable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<rows.length;i++){
var row=rows[i];
row[opts.idField]=row[opts.idField]||("foot-row-id"+i);
_7c3.push("<tr class=\"datagrid-row\" node-id=\""+row[opts.idField]+"\">");
_7c3.push(this.renderRow.call(this,_7bf,_7c2,_7c1,0,row));
_7c3.push("</tr>");
}
_7c3.push("</tbody></table>");
$(_7c0).html(_7c3.join(""));
},renderRow:function(_7c4,_7c5,_7c6,_7c7,row){
var opts=$.data(_7c4,"treegrid").options;
var cc=[];
if(_7c6&&opts.rownumbers){
cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\">0</div></td>");
}
for(var i=0;i<_7c5.length;i++){
var _7c8=_7c5[i];
var col=$(_7c4).datagrid("getColumnOption",_7c8);
if(col){
var css=col.styler?(col.styler(row[_7c8],row)||""):"";
var _7c9="";
var _7ca="";
if(typeof css=="string"){
_7ca=css;
...
var cls=_7c9?"class=\""+_7c9+"\"":"";
var _7cb=col.hidden?"style=\"display:none;"+_7ca+"\"":(_7ca?"style=\""+_7ca+"\"":"");
cc.push("<td field=\""+_7c8+"\" "+cls+" "+_7cb+">");
if(col.checkbox){
var _7cb="";
}else{
var _7cb=_7ca;
if(col.align){
_7cb+=";text-align:"+col.align+";";
}
if(!opts.nowrap){
_7cb+=";white-space:normal;height:auto;";
}else{
if(opts.autoRowHeight){
_7cb+=";height:auto;";
}
...
cc.push(" name=\""+_7c8+"\" value=\""+(row[_7c8]!=undefined?row[_7c8]:"")+"\"/>");
}else{
var val=null;
if(col.formatter){
val=col.formatter(row[_7c8],row);
}else{
val=row[_7c8];
}
if(_7c8==opts.treeField){
for(var j=0;j<_7c7;j++){
cc.push("<span class=\"tree-indent\"></span>");
}
if(row.state=="closed"){
cc.push("<span class=\"tree-hit tree-collapsed\"></span>");
...
return cc.join("");
},refreshRow:function(_7cc,id){
this.updateRow.call(this,_7cc,id,{});
},updateRow:function(_7cd,id,row){
var opts=$.data(_7cd,"treegrid").options;
var _7ce=$(_7cd).treegrid("find",id);
$.extend(_7ce,row);
var _7cf=$(_7cd).treegrid("getLevel",id)-1;
var _7d0=opts.rowStyler?opts.rowStyler.call(_7cd,_7ce):"";
function _7d1(_7d2){
var _7d3=$(_7cd).treegrid("getColumnFields",_7d2);
var tr=opts.finder.getTr(_7cd,id,"body",(_7d2?1:2));
var _7d4=tr.find("div.datagrid-cell-rownumber").html();
var _7d5=tr.find("div.datagrid-cell-check input[type=checkbox]").is(":checked");
tr.html(this.renderRow(_7cd,_7d3,_7d2,_7cf,_7ce));
tr.attr("style",_7d0||"");
tr.find("div.datagrid-cell-rownumber").html(_7d4);
if(_7d5){
tr.find("div.datagrid-cell-check input[type=checkbox]")._propAttr("checked",true);
}
};
...
$(_7cd).treegrid("fixRowHeight",id);
},onBeforeRender:function(_7d6,_7d7,data){
if($.isArray(_7d7)){
data={total:_7d7.length,rows:_7d7};
_7d7=null;
}
if(!data){
return false;
}
var _7d8=$.data(_7d6,"treegrid");
var opts=_7d8.options;
if(data.length==undefined){
if(data.footer){
_7d8.footer=data.footer;
}
if(data.total){
_7d8.total=data.total;
}
data=this.transfer(_7d6,_7d7,data.rows);
}else{
...
row._parentId=_7db;
if(row.children&&row.children.length){
_7d9(row.children,row[opts.idField]);
}
}
};
_7d9(data,_7d7);
}
var node=find(_7d6,_7d7);
if(node){
if(node.children){
...
_7d8.data=_7d8.data.concat(data);
}
this.sort(_7d6,data);
this.treeNodes=data;
this.treeLevel=$(_7d6).treegrid("getLevel",_7d7);
},sort:function(_7dc,data){
...
var sn=_7dd[i];
var so=_7de[i];
var col=$(_7dc).treegrid("getColumnOption",sn);
var _7e0=col.sorter||function(a,b){
return a==b?0:(a>b?1:-1);
};
r=_7e0(r1[sn],r2[sn])*(so=="asc"?1:-1);
if(r!=0){
return r;
}
}
...
for(var i=0;i<rows.length;i++){
var _7e1=rows[i].children;
if(_7e1&&_7e1.length){
_7df(_7e1);
}
}
};
},transfer:function(_7e2,_7e3,data){
...
$.fn.treegrid.defaults=$.extend({},$.fn.datagrid.defaults,{treeField:null,animate:false,singleSelect:true,view:_7ae,loader:function(_7e5,_7e6,_7e7){
var opts=$(this).treegrid("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:_7e5,dataType:"json",success:function(data){
_7e6(data);
},error:function(){
_7e7.apply(this,arguments);
}});
},loadFilter:function(data,_7e8){
return data;
},finder:{getTr:function(_7e9,id,type,_7ea){
type=type||"body";
_7ea=_7ea||0;
var dc=$.data(_7e9,"datagrid").dc;
if(_7ea==0){
var opts=$.data(_7e9,"treegrid").options;
var tr1=opts.finder.getTr(_7e9,id,type,1);
var tr2=opts.finder.getTr(_7e9,id,type,2);
return tr1.add(tr2);
}else{
if(type=="body"){
var tr=$("#"+$.data(_7e9,"datagrid").rowIdPrefix+"-"+_7ea+"-"+id);
if(!tr.length){
tr=(_7ea==1?dc.body1:dc.body2).find("tr[node-id=\""+id+"\"]");
}
return tr;
}else{
if(type=="footer"){
return (_7ea==1?dc.footer1:dc.footer2).find("tr[node-id=\""+id+"\"]");
}else{
if(type=="selected"){
return (_7ea==1?dc.body1:dc.body2).find("tr.datagrid-row-selected");
}else{
if(type=="highlight"){
return (_7ea==1?dc.body1:dc.body2).find("tr.datagrid-row-over");
}else{
if(type=="checked"){
return (_7ea==1?dc.body1:dc.body2).find("tr.datagrid-row-checked");
}else{
if(type=="last"){
return (_7ea==1?dc.body1:dc.body2).find("tr:last[node-id]");
}else{
if(type=="allbody"){
return (_7ea==1?dc.body1:dc.body2).find("tr[node-id]");
}else{
if(type=="allfooter"){
return (_7ea==1?dc.footer1:dc.footer2).find("tr[node-id]");
}
}
}
}
...
},getRow:function(_7eb,p){
var id=(typeof p=="object")?p.attr("node-id"):p;
return $(_7eb).treegrid("find",id);
}},onBeforeLoad:function(row,_7ec){
...
},onClickCell:function(_7ed,row){
},onDblClickCell:function(_7ee,row){
},onContextMenu:function(e,row){
},onBeforeEdit:function(row){
},onAfterEdit:function(row,_7ef){
},onCancelEdit:function(row){
}});
})(jQuery);
(function($){
function _7f0(_7f1,_7f2){
var _7f3=$.data(_7f1,"combo");
...
_7f4.appendTo("body");
var _7f6=_7f4.find("input.combo-text");
var _7f7=_7f4.find(".combo-arrow");
var _7f8=opts.hasDownArrow?_7f7._outerWidth():0;
_7f4._outerWidth(opts.width)._outerHeight(opts.height);
_7f6._outerWidth(_7f4.width()-_7f8);
_7f6.css({height:_7f4.height()+"px",lineHeight:_7f4.height()+"px"});
_7f7._outerHeight(_7f4.height());
_7f5.panel("resize",{width:(opts.panelWidth?opts.panelWidth:_7f4.outerWidth()),height:opts.panelHeight});
_7f4.insertAfter(_7f1);
};
function init(_7f9){
$(_7f9).addClass("combo-f").hide();
var span=$("<span class=\"combo\">"+"<input type=\"text\" class=\"combo-text\" autocomplete=\"off\">"+"<span><span class=\"combo-arrow\"></span></span>"+"<input type=\"hidden\" class=\"combo-value\">"+"</span>").insertAfter(_7f9);
var _7fa=$("<div class=\"combo-panel\"></div>").appendTo("body");
_7fa.panel({doSize:false,closed:true,cls:"combo-p",style:{position:"absolute",zIndex:10},onOpen:function(){
$(this).panel("resize");
},onClose:function(){
var _7fb=$.data(_7f9,"combo");
if(_7fb){
_7fb.options.onHidePanel.call(_7f9);
}
}});
var name=$(_7f9).attr("name");
if(name){
span.find("input.combo-value").attr("name",name);
$(_7f9).removeAttr("name").attr("comboName",name);
}
return {combo:span,panel:_7fa};
};
function _7fc(_7fd){
var _7fe=$.data(_7fd,"combo");
var opts=_7fe.options;
var _7ff=_7fe.combo;
if(opts.hasDownArrow){
_7ff.find(".combo-arrow").show();
}else{
_7ff.find(".combo-arrow").hide();
}
_800(_7fd,opts.disabled);
_801(_7fd,opts.readonly);
};
function _802(_803){
var _804=$.data(_803,"combo");
var _805=_804.combo.find("input.combo-text");
_805.validatebox("destroy");
_804.panel.panel("destroy");
_804.combo.remove();
$(_803).remove();
};
function _806(_807){
$(_807).find(".combo-f").each(function(){
...
var _80b=_80a.panel;
var _80c=_80a.combo;
var _80d=_80c.find(".combo-text");
var _80e=_80c.find(".combo-arrow");
...
_80d.bind("click.combo",function(e){
if(!opts.editable){
_80f.call(this);
}else{
var p=$(this).closest("div.combo-panel");
$("div.combo-panel:visible").not(_80b).not(p).panel("close");
}
}).bind("keydown.combo",function(e){
switch(e.keyCode){
case 38:
opts.keyHandler.up.call(_809,e);
break;
case 40:
opts.keyHandler.down.call(_809,e);
break;
case 37:
opts.keyHandler.left.call(_809,e);
break;
case 39:
opts.keyHandler.right.call(_809,e);
break;
case 13:
e.preventDefault();
opts.keyHandler.enter.call(_809,e);
return false;
case 9:
case 27:
_810(_809);
...
if(opts.editable){
if(_80a.timer){
clearTimeout(_80a.timer);
}
_80a.timer=setTimeout(function(){
var q=_80d.val();
if(_80a.previousValue!=q){
_80a.previousValue=q;
$(_809).combo("showPanel");
opts.keyHandler.query.call(_809,_80d.val(),e);
$(_809).combo("validate");
}
},opts.delay);
}
...
_80e.bind("click.combo",function(){
_80f.call(this);
...
function _811(_812){
var opts=$.data(_812,"combo").options;
var _813=$.data(_812,"combo").combo;
var _814=$.data(_812,"combo").panel;
if($.fn.window){
_814.panel("panel").css("z-index",$.fn.window.defaults.zIndex++);
}
_814.panel("move",{left:_813.offset().left,top:_815()});
if(_814.panel("options").closed){
_814.panel("open");
opts.onShowPanel.call(_812);
}
(function(){
if(_814.is(":visible")){
_814.panel("move",{left:_816(),top:_815()});
setTimeout(arguments.callee,200);
}
})();
function _816(){
var left=_813.offset().left;
if(left+_814._outerWidth()>$(window)._outerWidth()+$(document).scrollLeft()){
left=$(window)._outerWidth()+$(document).scrollLeft()-_814._outerWidth();
}
if(left<0){
left=0;
}
...
function _815(){
var top=_813.offset().top+_813._outerHeight();
if(top+_814._outerHeight()>$(window)._outerHeight()+$(document).scrollTop()){
top=_813.offset().top-_814._outerHeight();
}
if(top<$(document).scrollTop()){
top=_813.offset().top+_813._outerHeight();
}
return top;
};
};
function _810(_817){
var _818=$.data(_817,"combo").panel;
_818.panel("close");
};
function _819(_81a){
var opts=$.data(_81a,"combo").options;
var _81b=$(_81a).combo("textbox");
_81b.validatebox($.extend({},opts,{deltaX:(opts.hasDownArrow?opts.deltaX:(opts.deltaX>0?1:-1))}));
};
function _800(_81c,_81d){
var _81e=$.data(_81c,"combo");
var opts=_81e.options;
var _81f=_81e.combo;
if(_81d){
opts.disabled=true;
$(_81c).attr("disabled",true);
_81f.find(".combo-value").attr("disabled",true);
_81f.find(".combo-text").attr("disabled",true);
}else{
opts.disabled=false;
$(_81c).removeAttr("disabled");
_81f.find(".combo-value").removeAttr("disabled");
_81f.find(".combo-text").removeAttr("disabled");
}
};
function _801(_820,mode){
var _821=$.data(_820,"combo");
var opts=_821.options;
opts.readonly=mode==undefined?true:mode;
var _822=opts.readonly?true:(!opts.editable);
_821.combo.find(".combo-text").attr("readonly",_822).css("cursor",_822?"pointer":"");
};
function _823(_824){
var _825=$.data(_824,"combo");
var opts=_825.options;
var _826=_825.combo;
if(opts.multiple){
_826.find("input.combo-value").remove();
}else{
_826.find("input.combo-value").val("");
}
_826.find("input.combo-text").val("");
};
function _827(_828){
var _829=$.data(_828,"combo").combo;
return _829.find("input.combo-text").val();
};
function _82a(_82b,text){
var _82c=$.data(_82b,"combo");
var _82d=_82c.combo.find("input.combo-text");
if(_82d.val()!=text){
_82d.val(text);
$(_82b).combo("validate");
_82c.previousValue=text;
}
};
function _82e(_82f){
var _830=[];
var _831=$.data(_82f,"combo").combo;
_831.find("input.combo-value").each(function(){
_830.push($(this).val());
});
return _830;
};
function _832(_833,_834){
var opts=$.data(_833,"combo").options;
var _835=_82e(_833);
var _836=$.data(_833,"combo").combo;
_836.find("input.combo-value").remove();
var name=$(_833).attr("comboName");
for(var i=0;i<_834.length;i++){
var _837=$("<input type=\"hidden\" class=\"combo-value\">").appendTo(_836);
if(name){
_837.attr("name",name);
}
_837.val(_834[i]);
...
if(aa.length!=_834.length||_834.length!=_835.length){
if(opts.multiple){
opts.onChange.call(_833,_834,_835);
}else{
opts.onChange.call(_833,_834[0],_835[0]);
}
}
};
function _838(_839){
...
_832(_83f,opts.value);
}else{
_83b(_83f,opts.value);
}
}else{
_832(_83f,[]);
}
opts.originalValue=_82e(_83f);
}else{
_83b(_83f,opts.value);
...
$.fn.combo=function(_840,_841){
if(typeof _840=="string"){
var _842=$.fn.combo.methods[_840];
if(_842){
return _842(this,_841);
}else{
return this.each(function(){
var _843=$(this).combo("textbox");
_843.validatebox(_840,_841);
});
}
}
_840=_840||{};
return this.each(function(){
var _844=$.data(this,"combo");
if(_844){
$.extend(_844.options,_840);
}else{
var r=init(this);
_844=$.data(this,"combo",{options:$.extend({},$.fn.combo.defaults,$.fn.combo.parseOptions(this),_840),combo:r.combo,panel:r.panel,previousValue:null});
$(this).removeAttr("disabled");
}
_7fc(this);
_7f0(this);
...
var _846=$.data(jq[0],"combo").combo.find("input.combo-text");
return _846.validatebox("isValid");
},clear:function(jq){
return jq.each(function(){
_823(this);
});
...
return _82e(jq[0]);
},setValues:function(jq,_847){
return jq.each(function(){
_832(this,_847);
});
},getValue:function(jq){
return _838(jq[0]);
},setValue:function(jq,_848){
return jq.each(function(){
_83b(this,_848);
});
}};
$.fn.combo.parseOptions=function(_849){
var t=$(_849);
return $.extend({},$.fn.validatebox.parseOptions(_849),$.parser.parseOptions(_849,["width","height","separator",{panelWidth:"number",editable:"boolean",hasDownArrow:"boolean",delay:"number",selectOnNavigation:"boolean"}]),{panelHeight:(t.attr("panelHeight")=="auto"?"auto":parseInt(t.attr("panelHeight"))||undefined),multiple:(t.attr("multiple")?true:undefined),disabled:(t.attr("disabled")?true:undefined),readonly:(t.attr("readonly")?true:undefined),value:(t.val()||undefined)});
};
...
},onChange:function(_84a,_84b){
}});
})(jQuery);
(function($){
function _84c(_84d,_84e,_84f,_850){
var _851=$.data(_84d,"combobox");
var opts=_851.options;
if(_850){
return _852(_851.groups,_84f,_84e);
}else{
return _852(_851.data,(_84f?_84f:_851.options.valueField),_84e);
}
function _852(data,key,_853){
for(var i=0;i<data.length;i++){
var row=data[i];
if(row[key]==_853){
return row;
...
var _857=$(_855).combo("panel");
var row=_84c(_855,_856);
if(row){
var item=$("#"+row.domId);
if(item.position().top<=0){
var h=_857.scrollTop()+item.position().top;
_857.scrollTop(h);
}else{
if(item.position().top+item.outerHeight()>_857.height()){
var h=_857.scrollTop()+item.position().top+item.outerHeight()-_857.height();
_857.scrollTop(h);
}
}
}
};
function nav(_858,dir){
var opts=$.data(_858,"combobox").options;
var _859=$(_858).combobox("panel");
var item=_859.children("div.combobox-item-hover");
if(!item.length){
item=_859.children("div.combobox-item-selected");
}
item.removeClass("combobox-item-hover");
var _85a="div.combobox-item:visible:not(.combobox-item-disabled):first";
var _85b="div.combobox-item:visible:not(.combobox-item-disabled):last";
if(!item.length){
item=_859.children(dir=="next"?_85a:_85b);
}else{
if(dir=="next"){
item=item.nextAll(_85a);
if(!item.length){
item=_859.children(_85a);
}
}else{
item=item.prevAll(_85a);
if(!item.length){
item=_859.children(_85b);
}
}
}
if(item.length){
item.addClass("combobox-item-hover");
var row=_84c(_858,item.attr("id"),"domId");
if(row){
_854(_858,row[opts.valueField]);
if(opts.selectOnNavigation){
_85c(_858,row[opts.valueField]);
}
}
}
};
...
var _85f=$(_85d).combo("getValues");
if($.inArray(_85e+"",_85f)==-1){
if(opts.multiple){
_85f.push(_85e);
}else{
_85f=[_85e];
...
_860(_85d,_85f);
opts.onSelect.call(_85d,_84c(_85d,_85e));
}
};
function _861(_862,_863){
var opts=$.data(_862,"combobox").options;
var _864=$(_862).combo("getValues");
var _865=$.inArray(_863+"",_864);
if(_865>=0){
_864.splice(_865,1);
_860(_862,_864);
opts.onUnselect.call(_862,_84c(_862,_863));
}
};
function _860(_866,_867,_868){
var opts=$.data(_866,"combobox").options;
var _869=$(_866).combo("panel");
_869.find("div.combobox-item-selected").removeClass("combobox-item-selected");
var vv=[],ss=[];
...
$(_866).combo("setValues",vv);
if(!_868){
$(_866).combo("setText",ss.join(opts.separator));
}
};
var _86a=1;
function _86b(_86c,data,_86d){
var _86e=$.data(_86c,"combobox");
var opts=_86e.options;
_86e.data=opts.loadFilter.call(_86c,data);
_86e.groups=[];
data=_86e.data;
var _86f=$(_86c).combobox("getValues");
var dd=[];
var _870=undefined;
for(var i=0;i<data.length;i++){
var row=data[i];
...
if(_870!=g){
_870=g;
var grow={value:g,domId:("_easyui_combobox_"+_86a++)};
_86e.groups.push(grow);
dd.push("<div id=\""+grow.domId+"\" class=\"combobox-group\">");
dd.push(opts.groupFormatter?opts.groupFormatter.call(_86c,g):g);
dd.push("</div>");
}
}else{
_870=undefined;
...
row.domId="_easyui_combobox_"+_86a++;
dd.push("<div id=\""+row.domId+"\" class=\""+cls+"\">");
dd.push(opts.formatter?opts.formatter.call(_86c,row):s);
dd.push("</div>");
if(row["selected"]&&$.inArray(v,_86f)==-1){
_86f.push(v);
}
}
$(_86c).combo("panel").html(dd.join(""));
if(opts.multiple){
_860(_86c,_86f,_86d);
}else{
_860(_86c,_86f.length?[_86f[_86f.length-1]]:[],_86d);
}
opts.onLoadSuccess.call(_86c,data);
};
function _871(_872,url,_873,_874){
var opts=$.data(_872,"combobox").options;
if(url){
opts.url=url;
}
_873=_873||{};
if(opts.onBeforeLoad.call(_872,_873)==false){
return;
}
opts.loader.call(_872,_873,function(data){
_86b(_872,data,_874);
},function(){
...
if(opts.mode=="remote"){
_871(_876,null,{q:q},true);
}else{
var _878=$(_876).combo("panel");
_878.find("div.combobox-item,div.combobox-group").hide();
var data=_877.data;
var _879=undefined;
for(var i=0;i<data.length;i++){
var row=data[i];
if(opts.filter.call(_876,q,row)){
var v=row[opts.valueField];
var s=row[opts.textField];
var g=row[opts.groupField];
...
if(opts.groupField&&_879!=g){
var grow=_84c(_876,g,"value",true);
if(grow){
$("#"+grow.domId).show();
}
_879=g;
...
var _87c=t.combobox("panel");
var item=_87c.children("div.combobox-item-hover");
if(!item.length){
item=_87c.children("div.combobox-item-selected");
}
if(!item.length){
return;
}
var row=_84c(_87b,item.attr("id"),"domId");
if(!row){
return;
}
var _87d=row[opts.valueField];
if(opts.multiple){
if(item.hasClass("combobox-item-selected")){
t.combobox("unselect",_87d);
}else{
t.combobox("select",_87d);
}
}else{
t.combobox("select",_87d);
...
function _87f(_880){
var opts=$.data(_880,"combobox").options;
$(_880).addClass("combobox-f");
$(_880).combo($.extend({},opts,{onShowPanel:function(){
$(_880).combo("panel").find("div.combobox-item,div.combobox-group").show();
_854(_880,$(_880).combobox("getValue"));
opts.onShowPanel.call(_880);
}}));
$(_880).combo("panel").unbind().bind("mouseover",function(e){
...
var row=_84c(_880,item.attr("id"),"domId");
if(!row){
return;
}
...
$.fn.combobox=function(_882,_883){
if(typeof _882=="string"){
var _884=$.fn.combobox.methods[_882];
if(_884){
return _884(this,_883);
}else{
return this.combo(_882,_883);
}
}
_882=_882||{};
return this.each(function(){
var _885=$.data(this,"combobox");
if(_885){
$.extend(_885.options,_882);
_87f(this);
}else{
_885=$.data(this,"combobox",{options:$.extend({},$.fn.combobox.defaults,$.fn.combobox.parseOptions(this),_882),data:[]});
_87f(this);
...
if(_885.options.data){
_86b(this,_885.options.data);
}
_871(this);
});
};
$.fn.combobox.methods={options:function(jq){
var _886=jq.combo("options");
return $.extend($.data(jq[0],"combobox").options,{originalValue:_886.originalValue,disabled:_886.disabled,readonly:_886.readonly});
},getData:function(jq){
return $.data(jq[0],"combobox").data;
},setValues:function(jq,_887){
return jq.each(function(){
_860(this,_887);
});
},setValue:function(jq,_888){
return jq.each(function(){
_860(this,[_888]);
});
},clear:function(jq){
return jq.each(function(){
$(this).combo("clear");
var _889=$(this).combo("panel");
_889.find("div.combobox-item-selected").removeClass("combobox-item-selected");
});
},reset:function(jq){
return jq.each(function(){
...
},select:function(jq,_88a){
return jq.each(function(){
_85c(this,_88a);
});
},unselect:function(jq,_88b){
return jq.each(function(){
_861(this,_88b);
});
}};
$.fn.combobox.parseOptions=function(_88c){
var t=$(_88c);
return $.extend({},$.fn.combo.parseOptions(_88c),$.parser.parseOptions(_88c,["valueField","textField","groupField","mode","method","url"]));
};
$.fn.combobox.parseData=function(_88d){
var data=[];
var opts=$(_88d).combobox("options");
$(_88d).children().each(function(){
if(this.tagName.toLowerCase()=="optgroup"){
var _88e=$(this).attr("label");
...
row[opts.groupField]=_890;
}
data.push(row);
};
};
$.fn.combobox.defaults=$.extend({},$.fn.combo.defaults,{valueField:"value",textField:"text",groupField:null,groupFormatter:function(_891){
return _891;
...
},loader:function(_892,_893,_894){
var opts=$(this).combobox("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:_892,dataType:"json",success:function(data){
_893(data);
},error:function(){
_894.apply(this,arguments);
}});
},loadFilter:function(data){
return data;
},onBeforeLoad:function(_895){
},onLoadSuccess:function(){
},onLoadError:function(){
},onSelect:function(_896){
},onUnselect:function(_897){
}});
})(jQuery);
(function($){
function _898(_899){
var opts=$.data(_899,"combotree").options;
var tree=$.data(_899,"combotree").tree;
$(_899).addClass("combotree-f");
$(_899).combo(opts);
var _89a=$(_899).combo("panel");
if(!tree){
tree=$("<ul></ul>").appendTo(_89a);
$.data(_899,"combotree").tree=tree;
}
tree.tree($.extend({},opts,{checkbox:opts.multiple,onLoadSuccess:function(node,data){
var _89b=$(_899).combotree("getValues");
if(opts.multiple){
var _89c=tree.tree("getChecked");
...
$(_899).combotree("setValues",_89b);
opts.onLoadSuccess.call(this,node,data);
},onClick:function(node){
_89e(_899);
$(_899).combo("hidePanel");
opts.onClick.call(this,node);
},onCheck:function(node,_89d){
_89e(_899);
opts.onCheck.call(this,node,_89d);
}}));
};
function _89e(_89f){
var opts=$.data(_89f,"combotree").options;
var tree=$.data(_89f,"combotree").tree;
var vv=[],ss=[];
if(opts.multiple){
var _8a0=tree.tree("getChecked");
...
$(_89f).combo("setValues",vv).combo("setText",ss.join(opts.separator));
};
function _8a1(_8a2,_8a3){
var opts=$.data(_8a2,"combotree").options;
var tree=$.data(_8a2,"combotree").tree;
...
$(_8a2).combo("setValues",vv).combo("setText",ss.join(opts.separator));
};
$.fn.combotree=function(_8a4,_8a5){
if(typeof _8a4=="string"){
var _8a6=$.fn.combotree.methods[_8a4];
if(_8a6){
return _8a6(this,_8a5);
}else{
return this.combo(_8a4,_8a5);
}
}
_8a4=_8a4||{};
return this.each(function(){
var _8a7=$.data(this,"combotree");
if(_8a7){
$.extend(_8a7.options,_8a4);
}else{
$.data(this,"combotree",{options:$.extend({},$.fn.combotree.defaults,$.fn.combotree.parseOptions(this),_8a4)});
}
_898(this);
});
};
$.fn.combotree.methods={options:function(jq){
var _8a8=jq.combo("options");
return $.extend($.data(jq[0],"combotree").options,{originalValue:_8a8.originalValue,disabled:_8a8.disabled,readonly:_8a8.readonly});
},tree:function(jq){
...
},setValues:function(jq,_8a9){
return jq.each(function(){
_8a1(this,_8a9);
});
},setValue:function(jq,_8aa){
return jq.each(function(){
_8a1(this,[_8aa]);
});
},clear:function(jq){
...
$.fn.combotree.parseOptions=function(_8ab){
return $.extend({},$.fn.combo.parseOptions(_8ab),$.fn.tree.parseOptions(_8ab));
};
$.fn.combotree.defaults=$.extend({},$.fn.combo.defaults,$.fn.tree.defaults,{editable:false});
})(jQuery);
(function($){
function _8ac(_8ad){
var _8ae=$.data(_8ad,"combogrid");
var opts=_8ae.options;
var grid=_8ae.grid;
$(_8ad).addClass("combogrid-f").combo(opts);
var _8af=$(_8ad).combo("panel");
if(!grid){
grid=$("<table></table>").appendTo(_8af);
_8ae.grid=grid;
}
grid.datagrid($.extend({},opts,{border:false,fit:true,singleSelect:(!opts.multiple),onLoadSuccess:function(data){
var _8b0=$(_8ad).combo("getValues");
var _8b1=opts.onSelect;
opts.onSelect=function(){
};
_8bb(_8ad,_8b0,_8ae.remainText);
opts.onSelect=_8b1;
opts.onLoadSuccess.apply(_8ad,arguments);
},onClickRow:_8b2,onSelect:function(_8b3,row){
_8b4();
opts.onSelect.call(this,_8b3,row);
},onUnselect:function(_8b5,row){
_8b4();
opts.onUnselect.call(this,_8b5,row);
},onSelectAll:function(rows){
_8b4();
...
function _8b2(_8b6,row){
_8ae.remainText=false;
_8b4();
if(!opts.multiple){
$(_8ad).combo("hidePanel");
}
opts.onClickRow.call(this,_8b6,row);
};
function _8b4(){
...
if(!opts.multiple){
$(_8ad).combo("setValues",(vv.length?vv:[""]));
}else{
$(_8ad).combo("setValues",vv);
}
if(!_8ae.remainText){
$(_8ad).combo("setText",ss.join(opts.separator));
}
};
};
function nav(_8b7,dir){
var _8b8=$.data(_8b7,"combogrid");
var opts=_8b8.options;
var grid=_8b8.grid;
var _8b9=grid.datagrid("getRows").length;
if(!_8b9){
return;
}
...
var _8ba;
if(!tr.length){
_8ba=(dir=="next"?0:_8b9-1);
}else{
var _8ba=parseInt(tr.attr("datagrid-row-index"));
_8ba+=(dir=="next"?1:-1);
if(_8ba<0){
_8ba=_8b9-1;
}
...
grid.datagrid("highlightRow",_8ba);
if(opts.selectOnNavigation){
_8b8.remainText=false;
grid.datagrid("selectRow",_8ba);
}
};
function _8bb(_8bc,_8bd,_8be){
var _8bf=$.data(_8bc,"combogrid");
var opts=_8bf.options;
var grid=_8bf.grid;
var rows=grid.datagrid("getRows");
var ss=[];
var _8c0=$(_8bc).combo("getValues");
var _8c1=$(_8bc).combo("options");
var _8c2=_8c1.onChange;
_8c1.onChange=function(){
};
grid.datagrid("clearSelections");
for(var i=0;i<_8bd.length;i++){
var _8c3=grid.datagrid("getRowIndex",_8bd[i]);
if(_8c3>=0){
grid.datagrid("selectRow",_8c3);
ss.push(rows[_8c3][opts.textField]);
}else{
ss.push(_8bd[i]);
}
}
$(_8bc).combo("setValues",_8c0);
_8c1.onChange=_8c2;
$(_8bc).combo("setValues",_8bd);
if(!_8be){
var s=ss.join(opts.separator);
if($(_8bc).combo("getText")!=s){
$(_8bc).combo("setText",s);
}
}
};
function _8c4(_8c5,q){
var _8c6=$.data(_8c5,"combogrid");
var opts=_8c6.options;
var grid=_8c6.grid;
_8c6.remainText=true;
if(opts.multiple&&!q){
_8bb(_8c5,[],true);
}else{
_8bb(_8c5,[q],true);
...
var rows=grid.datagrid("getRows");
for(var i=0;i<rows.length;i++){
if(opts.filter.call(_8c5,q,rows[i])){
grid.datagrid("clearSelections");
...
_8c9.remainText=false;
var _8ca=parseInt(tr.attr("datagrid-row-index"));
if(opts.multiple){
if(tr.hasClass("datagrid-row-selected")){
grid.datagrid("unselectRow",_8ca);
}else{
grid.datagrid("selectRow",_8ca);
}
}else{
grid.datagrid("selectRow",_8ca);
$(_8c8).combogrid("hidePanel");
}
};
$.fn.combogrid=function(_8cb,_8cc){
if(typeof _8cb=="string"){
var _8cd=$.fn.combogrid.methods[_8cb];
if(_8cd){
return _8cd(this,_8cc);
}else{
return this.combo(_8cb,_8cc);
}
}
_8cb=_8cb||{};
return this.each(function(){
var _8ce=$.data(this,"combogrid");
if(_8ce){
$.extend(_8ce.options,_8cb);
}else{
_8ce=$.data(this,"combogrid",{options:$.extend({},$.fn.combogrid.defaults,$.fn.combogrid.parseOptions(this),_8cb)});
}
_8ac(this);
});
};
$.fn.combogrid.methods={options:function(jq){
var _8cf=jq.combo("options");
return $.extend($.data(jq[0],"combogrid").options,{originalValue:_8cf.originalValue,disabled:_8cf.disabled,readonly:_8cf.readonly});
},grid:function(jq){
...
$.fn.combogrid.parseOptions=function(_8d2){
var t=$(_8d2);
return $.extend({},$.fn.combo.parseOptions(_8d2),$.fn.datagrid.parseOptions(_8d2),$.parser.parseOptions(_8d2,["idField","textField","mode"]));
};
...
(function($){
function _8d3(_8d4){
var _8d5=$.data(_8d4,"datebox");
var opts=_8d5.options;
$(_8d4).addClass("datebox-f").combo($.extend({},opts,{onShowPanel:function(){
_8d6();
_8e0(_8d4,$(_8d4).datebox("getText"));
opts.onShowPanel.call(_8d4);
}}));
$(_8d4).combo("textbox").parent().addClass("datebox");
if(!_8d5.calendar){
_8d7();
}
function _8d7(){
var _8d8=$(_8d4).combo("panel").css("overflow","hidden");
var cc=$("<div class=\"datebox-calendar-inner\"></div>").appendTo(_8d8);
if(opts.sharedCalendar){
_8d5.calendar=$(opts.sharedCalendar).appendTo(cc);
if(!_8d5.calendar.hasClass("calendar")){
_8d5.calendar.calendar();
}
}else{
_8d5.calendar=$("<div></div>").appendTo(cc).calendar();
}
$.extend(_8d5.calendar.calendar("options"),{fit:true,border:false,onSelect:function(date){
var opts=$(this.target).datebox("options");
_8e0(this.target,opts.formatter(date));
$(this.target).combo("hidePanel");
opts.onSelect.call(_8d4,date);
}});
_8e0(_8d4,opts.value);
var _8d9=$("<div class=\"datebox-button\"></div>").appendTo(_8d8);
var _8da=$("<a href=\"javascript:void(0)\" class=\"datebox-current\"></a>").html(opts.currentText).appendTo(_8d9);
var _8db=$("<a href=\"javascript:void(0)\" class=\"datebox-close\"></a>").html(opts.closeText).appendTo(_8d9);
_8da.click(function(){
_8d5.calendar.calendar({year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date()});
});
_8db.click(function(){
...
var _8f4=_8f3.children("div.datebox-button");
var ok=$("<a href=\"javascript:void(0)\" class=\"datebox-ok\"></a>").html(opts.okText).appendTo(_8f4);
ok.click(function(){
_8fa(_8f0);
});
}
...
_8f5(_8f0,opts.value);
};
function _8f6(_8f7){
var c=$(_8f7).datetimebox("calendar");
var t=$(_8f7).datetimebox("spinner");
...
var date=_8f6(_8fb);
_8f5(_8fb,opts.formatter.call(_8fb,date));
$(_8fb).combo("hidePanel");
};
function _8f5(_8fc,_8fd,_8fe){
var opts=$.data(_8fc,"datetimebox").options;
$(_8fc).combo("setValue",_8fd);
if(!_8fe){
if(_8fd){
var date=opts.parser.call(_8fc,_8fd);
$(_8fc).combo("setValue",opts.formatter.call(_8fc,date));
$(_8fc).combo("setText",opts.formatter.call(_8fc,date));
}else{
$(_8fc).combo("setText",_8fd);
}
}
var date=opts.parser.call(_8fc,_8fd);
$(_8fc).datetimebox("calendar").calendar("moveTo",date);
$(_8fc).datetimebox("spinner").timespinner("setValue",_8ff(date));
function _8ff(date){
function _900(_901){
return (_901<10?"0":"")+_901;
};
var tt=[_900(date.getHours()),_900(date.getMinutes())];
if(opts.showSeconds){
tt.push(_900(date.getSeconds()));
}
return tt.join($(_8fc).datetimebox("spinner").timespinner("options").separator);
};
};
$.fn.datetimebox=function(_902,_903){
if(typeof _902=="string"){
var _904=$.fn.datetimebox.methods[_902];
if(_904){
return _904(this,_903);
}else{
return this.datebox(_902,_903);
}
}
_902=_902||{};
return this.each(function(){
var _905=$.data(this,"datetimebox");
if(_905){
$.extend(_905.options,_902);
}else{
$.data(this,"datetimebox",{options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_902)});
}
_8ef(this);
});
};
$.fn.datetimebox.methods={options:function(jq){
var _906=jq.datebox("options");
return $.extend($.data(jq[0],"datetimebox").options,{originalValue:_906.originalValue,disabled:_906.disabled,readonly:_906.readonly});
},spinner:function(jq){
return $.data(jq[0],"datetimebox").spinner;
},setValue:function(jq,_907){
return jq.each(function(){
_8f5(this,_907);
});
},reset:function(jq){
...
$.fn.datetimebox.parseOptions=function(_908){
var t=$(_908);
return $.extend({},$.fn.datebox.parseOptions(_908),$.parser.parseOptions(_908,["timeSeparator",{showSeconds:"boolean"}]));
};
...
function _909(_90a){
return (_90a<10?"0":"")+_90a;
};
var _90b=$(this).datetimebox("spinner").timespinner("options").separator;
var r=$.fn.datebox.defaults.formatter(date)+" "+_909(h)+_90b+_909(M);
...
var _90c=$(this).datetimebox("spinner").timespinner("options").separator;
var tt=dt[1].split(_90c);
var hour=parseInt(tt[0],10)||0;
var _90d=parseInt(tt[1],10)||0;
var _90e=parseInt(tt[2],10)||0;
return new Date(d.getFullYear(),d.getMonth(),d.getDate(),hour,_90d,_90e);
}});
})(jQuery);
(function($){
function init(_90f){
var _910=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:void(0)\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_90f);
var t=$(_90f);
t.addClass("slider-f").hide();
var name=t.attr("name");
if(name){
_910.find("input.slider-value").attr("name",name);
t.removeAttr("name").attr("sliderName",name);
}
return _910;
};
function _911(_912,_913){
var _914=$.data(_912,"slider");
var opts=_914.options;
var _915=_914.slider;
if(_913){
if(_913.width){
opts.width=_913.width;
}
if(_913.height){
opts.height=_913.height;
}
}
if(opts.mode=="h"){
_915.css("height","");
_915.children("div").css("height","");
if(!isNaN(opts.width)){
_915.width(opts.width);
}
}else{
_915.css("width","");
_915.children("div").css("width","");
if(!isNaN(opts.height)){
_915.height(opts.height);
_915.find("div.slider-rule").height(opts.height);
_915.find("div.slider-rulelabel").height(opts.height);
_915.find("div.slider-inner")._outerHeight(opts.height);
}
}
_916(_912);
};
function _917(_918){
var _919=$.data(_918,"slider");
...
_91b(aa);
function _91b(aa){
var rule=_91a.find("div.slider-rule");
var _91c=_91a.find("div.slider-rulelabel");
rule.empty();
_91c.empty();
for(var i=0;i<aa.length;i++){
var _91d=i*100/(aa.length-1)+"%";
var span=$("<span></span>").appendTo(rule);
span.css((opts.mode=="h"?"left":"top"),_91d);
if(aa[i]!="|"){
span=$("<span></span>").appendTo(_91c);
span.html(aa[i]);
if(opts.mode=="h"){
span.css({left:_91d,marginLeft:-Math.round(span.outerWidth()/2)});
}else{
span.css({top:_91d,marginTop:-Math.round(span.outerHeight()/2)});
}
}
}
};
...
function _91e(_91f){
var _920=$.data(_91f,"slider");
var opts=_920.options;
var _921=_920.slider;
_921.removeClass("slider-h slider-v slider-disabled");
_921.addClass(opts.mode=="h"?"slider-h":"slider-v");
_921.addClass(opts.disabled?"slider-disabled":"");
_921.find("a.slider-handle").draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
...
var _923=_935(_91f,left);
_924(_923);
return false;
}
},onBeforeDrag:function(){
_920.isDragging=true;
},onStartDrag:function(){
opts.onSlideStart.call(_91f,opts.value);
},onStopDrag:function(e){
var _925=_935(_91f,(opts.mode=="h"?e.data.left:e.data.top));
_924(_925);
opts.onSlideEnd.call(_91f,opts.value);
opts.onComplete.call(_91f,opts.value);
_920.isDragging=false;
}});
_921.find("div.slider-inner").unbind(".slider").bind("mousedown.slider",function(e){
if(_920.isDragging){
return;
}
var pos=$(this).offset();
var _926=_935(_91f,(opts.mode=="h"?(e.pageX-pos.left):(e.pageY-pos.top)));
_924(_926);
opts.onComplete.call(_91f,opts.value);
});
function _924(_927){
var s=Math.abs(_927%opts.step);
if(s<opts.step/2){
_927-=s;
}else{
_927=_927-s+opts.step;
}
_928(_91f,_927);
};
};
...
opts.value=_92a;
$(_929).val(_92a);
_92c.find("input.slider-value").val(_92a);
var pos=_92e(_929,_92a);
var tip=_92c.find(".slider-tip");
if(opts.showTip){
tip.show();
tip.html(opts.tipFormatter.call(_929,opts.value));
}else{
tip.hide();
}
if(opts.mode=="h"){
var _92f="left:"+pos+"px;";
_92c.find(".slider-handle").attr("style",_92f);
tip.attr("style",_92f+"margin-left:"+(-Math.round(tip.outerWidth()/2))+"px");
}else{
var _92f="top:"+pos+"px;";
_92c.find(".slider-handle").attr("style",_92f);
tip.attr("style",_92f+"margin-left:"+(-Math.round(tip.outerWidth()))+"px");
}
if(_92d!=_92a){
opts.onChange.call(_929,_92a,_92d);
}
};
function _916(_930){
var opts=$.data(_930,"slider").options;
var fn=opts.onChange;
opts.onChange=function(){
};
_928(_930,opts.value);
opts.onChange=fn;
};
function _92e(_931,_932){
var _933=$.data(_931,"slider");
var opts=_933.options;
var _934=_933.slider;
if(opts.mode=="h"){
var pos=(_932-opts.min)/(opts.max-opts.min)*_934.width();
if(opts.reversed){
pos=_934.width()-pos;
}
}else{
var pos=_934.height()-(_932-opts.min)/(opts.max-opts.min)*_934.height();
if(opts.reversed){
pos=_934.height()-pos;
}
}
...
function _935(_936,pos){
var _937=$.data(_936,"slider");
var opts=_937.options;
var _938=_937.slider;
if(opts.mode=="h"){
var _939=opts.min+(opts.max-opts.min)*(pos/_938.width());
}else{
var _939=opts.min+(opts.max-opts.min)*((_938.height()-pos)/_938.height());
}
return opts.reversed?opts.max-_939.toFixed(0):_939.toFixed(0);
};
$.fn.slider=function(_93a,_93b){
if(typeof _93a=="string"){
return $.fn.slider.methods[_93a](this,_93b);
}
_93a=_93a||{};
return this.each(function(){
var _93c=$.data(this,"slider");
if(_93c){
$.extend(_93c.options,_93a);
}else{
_93c=$.data(this,"slider",{options:$.extend({},$.fn.slider.defaults,$.fn.slider.parseOptions(this),_93a),slider:init(this)});
$(this).removeAttr("disabled");
}
...
$.fn.slider.parseOptions=function(_93f){
var t=$(_93f);
return $.extend({},$.parser.parseOptions(_93f,["width","height","mode",{reversed:"boolean",showTip:"boolean",min:"number",max:"number",step:"number"}]),{value:(t.val()||undefined),disabled:(t.attr("disabled")?true:undefined),rule:(t.attr("rule")?eval(t.attr("rule")):undefined)});
};
$.fn.slider.defaults={width:"auto",height:"auto",mode:"h",reversed:false,showTip:false,disabled:false,value:0,min:0,max:100,step:1,rule:[],tipFormatter:function(_940){
return _940;
},onChange:function(_941,_942){
},onSlideStart:function(_943){
},onSlideEnd:function(_944){
},onComplete:function(_945){
}};
})(jQuery);
