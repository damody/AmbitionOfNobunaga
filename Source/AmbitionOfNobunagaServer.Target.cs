...
public class AmbitionOfNobunagaServerTarget : TargetRules
{
    public AmbitionOfNobunagaServerTarget(TargetInfo Target)
    {
        ...
        )
    {
        ...
        OutExtraModuleNames.Add("AmbitionOfNobunaga");
    }
